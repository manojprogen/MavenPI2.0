...
var id1 = el1.attr('id') || multiselectID++; // unique ID for the label & option tags
    var elementid = el1.attr('name')
     var totalvalue=id1+"__"+elementid+"__"+$this;
  var idbuttin='multiselectt' + id1
  var checkall='ui-multiselect-all' + id1
var uncheckall='ui-multiselect-close' + id1
      var button = (this.button = $('<button id="'+idbuttin+'" value="'+totalvalue+'" title="'+id1+'" style="width:200px;background:#1B3E70; color:white;" type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
...
elementid=elementid1;
    ...
    showfiltersoview(elementid,"graph","event",left,top)
})
...
loadingtimegr=false;
var elementid1=idvalue.split("__")[1];
 setTimeout(setallfiltersone(name,elementid1,"uncheckall",""),2000);
...
loadingtimegr=false;
var elementid1=idvalue.split("__")[1];
 setTimeout(setallfiltersone(name,elementid1,"checkall",""),2000);
...
//                       value = o.selectedText.replace('#', 'All').replace('of # selected',o.noneSelectedText );
    ...
    value=value.substring(0,15)+".."
               ...
               if(numChecked==totalSelectOption){
                      if(loadingtimegr){
//                            loadingtimegr=false
                           $("#multiselectt"+id1).css({'background': '#279B61','color':'white'});
