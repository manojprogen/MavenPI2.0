        ...
        <%/***** Report Comments 
         ...
         <link href="../css/myStyles.css" rel="stylesheet" type="text/css">       
          ...
          <Script>
                ...
                my_window= window.open("pbPersonalisedReportRegister.jsp?reportid="+"1"+"&repparams="+"param1"+"&contextpath="+"/FirstRelease/Bharathi/report/JSPs/pbReportList.jsp","Create Personalised Report","status=1,width=500,height=500");
