...
<Head>
     ...
     <%/***** Report Comments 
            ...
            DisplayFrame disp = new DisplayFrame("","View My Personalised Reports and Shared Reports");
...
<Br>
    ...
    { 
        ...
        PbReturnObject retObj = Client.getPersonalisedReportList(UserId);
       ...
       String[] columnURLSValues={"","","PATH"};
        ...
        String forwardTo=request.getContextPath()+"/Bharathi/PersonalisedReports/JSPS/pbPersonalisedReportsList.jsp";
        ...
        TableUtilsRef.setAction(request.getContextPath()+"/Bharathi/PersonalisedReports/JSPS/pbPersonalisedReportsList.jsp");
    ...
    <Table width="100%">
        <Tr>
           <Form name="myForm2">
                  <Td width="100%" height="50%" align="CENTER"><Input class="btn" type="button" value="Edit" onclick="javascript:checkEdit('Report','pbPersonalisedReportGetUpdate.jsp');">
                 <Input class="btn" type="button" value="Delete" onclick="javascript:checkDelete('Report','pbPersonalisedReportDelete.jsp');"></Td>
         </Form>
         ...
         <tr>
                  <td width="100%" height="50%">
                      <HR>
                        ...
                        <iframe src="pbSharedReportList.jsp" width="100%" height="400" frameborder="0"></iframe>
