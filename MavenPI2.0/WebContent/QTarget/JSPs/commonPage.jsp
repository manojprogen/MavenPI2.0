...
<%@ page import="prg.util.TableUtils"%>
        ...
        <%  
            ...
            boolean[] columnFilterble;
             //  ////////////////////////////////////////////////////////////////////////.println("----TableUtilsRef---"+TableUtilsRef);
          ...
          //  ////////////////////////////////////////////////////////////////////////.println("----columnsVisibility.length------"+columnsVisibility.length);
            ...
            //////////////////////////////////////////////////////////////////////////.println("----TableUtilsRef.getItems()---- "+TableUtilsRef.getItems()+" ------TableUtilsRef.getTotalRecords()------ "+TableUtilsRef.getTotalRecords());
           // ////////////////////////////////////////////////////////////////////////.println("----alist in common page--------"+alist);
            HashMap hmap;
       ...
       // out.println(pageContext.getAttribute(TableUtilsRef.getItems()));
           // ////////////////////////////////////////////////////////////////////////.println("------TableUtilsRef.getImagePath()----------"+TableUtilsRef.getImagePath());
            %>    
            ...
            %>
             ...
             <% //counter++; 
              if(currentDisplayedRecords==null){
                 ...
                 //////////////////////////////////////////////////////////////////////////.println("-------------------- "+TableUtilsRef.getPageContext().getAttribute(TableUtilsRef.getVar()));
                // ////////////////////////////////////////////////////////////////////////.println("---TableUtilsRef.getPageContext()----- "+TableUtilsRef.getPageContext());
             ...
             <% 
                 ...
                 //////////////////////////////////////////////////////////////////////////.println("----currentDisplayedRecords---- "+currentDisplayedRecords);
             %>
