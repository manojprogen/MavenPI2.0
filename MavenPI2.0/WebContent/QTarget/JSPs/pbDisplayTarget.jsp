...
//            }
           ...
           function excelD()
           {
               ...
               document.forms.frmParameter.action ='<%=request.getContextPath()%>'+"/QTarget/JSPs/pbgotoExcel.jsp?Basis=Absolute";
               document.forms.frmParameter.submit();
           }
           function excelDPer()
           {
               //alert('in excelDPer =- ');
               document.forms.frmParameter.action ='<%=request.getContextPath()%>'+"/QTarget/JSPs/pbgotoExcel.jsp?Basis=Percent";
               document.forms.frmParameter.submit();
           ...
           function copyData(targetId)
              ...
              // alert(maxTimeLevel+ ' tertiaryViewBy '+tertiary+" pType "+pType);
               ...
               if(maxTimeLevel==pType&&tertiary=='Percentage'&&prim=="0")
               {
                ...
                if(sec!='Time')
                {
                        ...
                        {
                            document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value;
                            document.forms.frmParameter.submit();
                            return true;
                        }
                 }
            ...
            function submitDrill(drillUrl)
            {
                ...
                if(primParamEleId==viewby)
                   {
                        ...
                        var t = confirm("Are you sure you want to save.");
                            if(t==true){
                                            document.forms.frmParameter.action = "targetView.do?targetParams=saveTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                            document.forms.frmParameter.submit();
                                       }
                               else
                                   {
                                        document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                        document.forms.frmParameter.submit();
                                   }
                   }
                   else
                       ...
                       if(checkSum())
                           {
                               ...
                               {
                                        var t = confirm("Are you sure you want to drill without saving.");
                                         if(t==true)
                                         {
                                            document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                            document.forms.frmParameter.submit();
                ...
                else
                {
                    if(primParamEleId==viewby)
                     {
                        ...
                        var t = confirm("Are you sure you want to save.");
                            if(t==true){
                                            document.forms.frmParameter.action = "targetView.do?targetParams=allocateTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                            document.forms.frmParameter.submit();
                                       }
                               else
                                   {
                   ...
                   else
                   {
                       if(checkSum())
                           {
                               var t = confirm("Are you sure you want to save. It will allocate at "+minTimeLevel);
                               if(t==true)
                               {
                                            document.forms.frmParameter.action = "targetView.do?targetParams=allocateTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                            document.forms.frmParameter.submit();
                           ...
                           if(!checkSum())
                               {
                                         var t = confirm("Are you sure you want to drill.");
                                         if(t==true)
                                         {
                                              document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+drillUrl;
                                              document.forms.frmParameter.submit();
            ...
            {
                // alert('in timeDrill '+timeDrill);
                  var t = confirm("Are you sure you want Save and drill.");
                     if(t==true)
                     {
                          //"targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+timeDrill;
                        
                         document.forms.frmParameter.action ="targetView.do?targetParams=saveTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+timeDrill+"&tertiaryViewBy="+document.getElementById('tertiaryViewBy').value;;
                         document.forms.frmParameter.submit();
                     }
                     else
                         {
                         document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+timeDrill+"&tertiaryViewBy="+document.getElementById('tertiaryViewBy').value;
                         document.forms.frmParameter.submit();
                         }
            }
            ...
            {
               // alert(columnDrillUrl);
               if(checkRowSum())
               {
                   var t = confirm("Are you sure you want to save.");
                   if(t==true)
                   {
                                document.forms.frmParameter.action = "targetView.do?targetParams=saveTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+columnDrillUrl+"&tertiaryViewBy="+document.getElementById('tertiaryViewBy').value;
                                document.forms.frmParameter.submit();
                   }
                   else
                   {
               ...
               // document.forms.frmParameter.action = "targetView.do?targetParams=viewTarget&targetId="+document.forms.frmParameter.TARGETID.value+"&minTimeLevel="+document.forms.frmParameter.TIMELEVEL.value+columnDrillUrl;
              //  document.forms.frmParameter.submit();
            }
           ...
           function goToPrevPage(data){
            ...
            //alert("Here we have to upload the excel sheet");
                   ...
                   // frameobj.src ="/QTarget/JSPs/uploadExcel.jsp";
                    
                    frameobj = document.getElementById("uploadframe");
                    frameobj.src= "<%=request.getContextPath()%>/QTarget/JSPs/uploadExcel.jsp";
                    $("#uploadexcel").dialog('open');
                    //window.location.reload(true);
            <%--alert(frameobj.src);--%>
                }
             function cancelExcelClose()
             {
                 //alert(' in kdfdkj cancel ');
                // document.getElementById("uploadexcel").style.display='none';
                // document.getElementById("fade").style.display = 'none';
...
<%
      ...
      ArrayList rowEdgeValuesA = new ArrayList();
       ...
       String dataQuery2="";
       String dataQuery="";
        if (request.getAttribute("dataQuery")!= null)
       {
               dataQuery = (String)request.getAttribute("dataQuery");
       }
        if (request.getAttribute("dataQuery2")!= null)
       {
               dataQuery2 = (String)request.getAttribute("dataQuery2");
       }
        if (request.getAttribute("parentDataQ2")!= null)
       {
               parentDataQ2 = (String)request.getAttribute("parentDataQ2");
       }
        if (request.getAttribute("parentDataQ")!= null)
       {
               parentDataQ = (String)request.getAttribute("parentDataQ");
       }
       session.setAttribute("parentDataQ2",parentDataQ2);
       session.setAttribute("parentDataQ",parentDataQ);
       session.setAttribute("dataQuery2",dataQuery2);
       session.setAttribute("dataQuery",dataQuery);

     // HashMap viewByMap=(HashMap)request.getAttribute("viewByMap");
       ...
       //////////////////////////////////////////.println(" viewByMap in jsp "+viewByMap);
      /* String viewByMapArr[]=(String[])viewByMap.keySet().toArray(new String[0]);
       String vIds="";
       for(int y=0;y<viewByMapArr.length;y++)
           {
           vIds=vIds+","+viewByMapArr[y];
           }
       if(vIds.length()>0)
           vIds=vIds.substring(1); */
...
<!--                <a href="javascript:void(0)" onclick="javascript:logout()" style="font-size:10px;color:#369;font-weight:bold;text-decoration: none;font-family:Georgia"> Logout </a>-->
    ...
    <div id="targetDiv" class="ui-tabs ui-widget ui-widget-content ui-corner-all" style="width:100%;min-height:500px;max-height:100%">
        ...
        <form name="frmParameter" action="pbDisplayTarget.jsp" method="POST">
            ...
            <table style="width:100%" valign="top">
               ...
               <tr style="width:100%">
                    ...
                    <td valign="top">
                        ...
                        -<a href="javascript:void(0)" onclick="javascript:gotoExcel()"> Download To Excel </a> &nbsp;&nbsp;&nbsp;-<a href="javascript:void(0)" onclick="javascript:comeFromExcel()"> Upload From Excel</a></b></div>
            ...
            <form name="frmParameternew" method="post">
                ...
                <table>
                    <tr>
                        <td>
                            <input type="button" <%=freezeButton%> class="navtitle-hover" value="Save" onclick="goToSave()">
                            <%--<input type="button" <%=freezeButton%> class="btn" value="Save For Now" onclick="goToSaveTemporary()"> --%>
                            <input type="button"  class="navtitle-hover" value="Targets Home" onclick="goToTargetsHome2()">
                           <%-- <input type="button" class="btn" value="Show Graph" onclick="showGraph()">  --%>
                            <%--<Input type="BUTTON" value="Copy Data" onclick='copyData("<%=targetId%>")'> --%>
        ...
        <div id="uploadexcel" name="uploadexcel" title="Upload Excel">
            <iframe id="uploadframe" name="uploadframe" frameborder="0" marginheight="0" marginwidth="0" src='#' width="100%" height="100%"></iframe>
        </div>

         <div id="BasisDialog" name="BasisDialog" title="Entry Basis">
            <%--<iframe id="Basisframe" name="Basisframe" frameborder="0" marginheight="0" marginwidth="0" src='#' width="100%" height="100%"></iframe>--%>
               <label><b>Do You want to download in Percentage Form.</b></label>

        </div>

         <div id="uploadDialog" title="upload" style="height:100%;width:100%">
