...
<html>
    ...
    <body onload="sample()">
        ...
        String grpId="";
        String grpName="";
        if(measurObj.getRowCount()>0)
            {
         measureName = measurObj.getFieldValueString(0, "MEASURE_NAME");
         grpId= measurObj.getFieldValueString(0, "BUSINESS_GROUP");
         grpName= measurObj.getFieldValueString(0, "GRP_NAME");
        }
        ...
        <form name="myForm" method="post">
            <center>
                ...
                <table style="width:80%;line-height:24px">
                    ...
                    <tr>
                        <td><span style="color:red">*</span>Business Role</td>
                        <td>
                ...
                <%
                                        ...
                                        {
                                            temp = getBusinessAreas.getFieldValueString(i,"FOLDER_NAME");
                %>
