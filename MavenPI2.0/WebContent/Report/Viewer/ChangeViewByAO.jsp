...
<%-- 
    Document   : ChangeViewByAO
    Created on : Dec 16, 2015, 7:43:10 PM
    Author     : Amar
--%>
...
//                            parent.$("#measuresDialog").dialog('open');
                        ...
                        if(rowViewByArray=="" || prevREPIds==undefined ){
                            alert("Please select Row Edge 3")
                        }
                    }
                ...
                function createViewBY(elmntId,elementName,tarLoc){
                    //alert("elementIDs"+elmntId);
                    var parentUL=document.getElementById(tarLoc);
                    var x=ViewByArray.toString();
                    //var elmntIds = JSON.stringify(elmntId);
                    //alert(elmntIds);
                    //var elementIdsArr = JSON.parse(elmntIds);
                    //alert(tarLoc);
                    var elemetIds = elmntId;
                    if(tarLoc == "colViewUL"){
//                        if(colFlag == 0){
                    ...
                    //alert("element Lemgth"+elmntId.length);
