...
//                List<String> runtimeMeasNamesLst = null;
                ...
                if (session.getAttribute("rowViewIdList") != null) {
                    ...
                    rowMeasIdList = (List<String>) session.getAttribute("runtimeMeasNamesLst");
                    rowMeasNamesLst = (List<String>) session.getAttribute("runtimeMeasNamesLst");
//                    runtimeMeasNamesLst = (List<String>) session.getAttribute("runtimeMeasNamesLst");
                 ...
                 if(request.getParameter("flag")!=null && request.getParameter("flag")!="" || (request.getParameter("flag").equalsIgnoreCase("dualAxis") &&  request.getParameter("isComparison").equalsIgnoreCase("true"))){          
                       //                  graphFlag = "editMeasures";
                     rowMeasChStr1 = reportViewDAO.buildDragableRuntimeMeasure1(reportId,"RowViewBy", ctxPath,container,request.getParameter("chartId"),graphFlag);
                      colMeasChStr2 = reportViewDAO.buildDragableRuntimeMeasure2(reportId,"ColViewBy", ctxPath,container,request.getParameter("chartId"),graphFlag);
...
//                            viewByArray.push(colIds[i].id.replace("ViewBy",""));
                    ...
                    alert(JSON.stringify(rowViewByArray))
                    var rowViewNamesArr = [];
...
//                            //cols = cols+","+colIds[i].id.replace("GrpCol","");
                    ...
                    alert(JSON.stringify(rowMeasArray))
                    alert(JSON.stringify(measArray))
...
//                            chartDetails["aggregation"] = AggType;
                      //      chartDetails["dimensions"] = rowViewNamesArr;
                            ...
                            chartDetails["measures1"] = rowViewByArray;
                     
                   
                            chartDetails["measures2"] = rowMeasArray;
