...
function selectTime(ctl,ctl2,path) {
   // alert('in js')
    // imagePath=path;
    var leftpos=0
    var toppos=0
   ...
   // alert(imagePath + 'timepicker2.gif');
