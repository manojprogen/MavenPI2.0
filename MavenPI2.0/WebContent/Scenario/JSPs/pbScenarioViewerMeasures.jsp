<%-- 
    Document   : pbScenarioViewerMeasures
    Created on : May 26, 2010, 3:50:12 PM
...
<%
            ...
            String scenarioId = "";
            String scenarioName = "";
            scenarioId = (String) request.getAttribute("scenarioId");
...
<html>
    <head>
        ...
        <script>
            ...
            function saveViewerMeasures(){
                dispViewerMeasures();
            }
            function dispViewerMeasures(){
                var msrs="";
                ...
                if(msrIds.length!=0){
                    ...
                    //alert('msers are : '+msrs)
                    document.getElementById("MsrIds").value=msrs;
                    <%--document.getElementById("Measures").value=msrs;--%>
                    document.forms.myForm2.action=path+'/ScenarioViewerAction.do?scenarioParam=viewerNoramlQuery&scenarioId='+scenarioId+'&Msrs='+msrs+'&scenarioName='+scenarioName;
                    document.forms.myForm2.submit();
                    parent.window.location.href=parent.window.location.href;

                    <%--$.ajax({
                        url: path+'/ScenarioViewerAction.do?scenarioParam=viewerNoramlQuery&scenarioId='+scenarioId+'&Msrs='+msrs+'&scenarioName='+scenarioName,
                        success: function(data) {
                            if(data!=""){
                                alert('data is : '+data)
                                parent.document.getElementById("reTest").innerHTML=data;
                            }
                        }
                    });--%>
                    cancelViewerMeasure();
            ...
            function cancelViewerMeasure(){
                parent.$("#viewerMeasures").dialog('close');
            }
            ...
            $(function() {
                ...
                $(dropMeasures).droppable(
                {
                    ...
                    drop: function(ev, ui) {
                        ...
                        createViewerMeasures(ui.draggable.html(),ui.draggable.attr('id'));
                    }
                });
            });
            ...
            function prevMeasures(){
                ...
                if(prevMsrs.length!=0){
                    ...
                    for(var m=0;m<prevMsrs.length;m++){
                        ...
                        createViewerMeasures(msrElmnts[0],"elmnt-"+msrElmnts[1]);
                    }
                }
            }
    ...
    <body>
        ...
        <form name="myForm2" method="post">
            ...
            <INPUT TYPE="hidden" name="MsrIds" id="MsrIds">
            <br>
        ...
        <center>
            <table>
                <tr>
                    <td><input type="button" class="navtitle-hover" style="width:auto" value="Save" onclick="saveViewerMeasures()"></td>
                    <%--<td><input type="button" class="navtitle-hover" style="width:auto" value="Cancel" onclick="cancelViewerMeasure()"></td>--%>
                </tr>
            </table>
        </center>
    </body>
