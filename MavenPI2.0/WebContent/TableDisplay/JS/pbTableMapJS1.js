...
function doClear(colName,tabId,ctxPath){
 $.ajax({
        ...
        {   
            if ( data == 'refresh')
            {
                var source ="TableDisplay/pbDisplay.jsp?slidePages="+25+"&tabId="+tabId;
                var dSrc = document.getElementById("iframe1");
                dSrc.src = source;
            }
...
function doSort(colName,dataType,tabId,sortType){
    ...
    var source = "TableDisplay/pbDisplay.jsp?source=S&sort="+sortDescend+"&sortColumn="+colName+"&sortDataType="+dataType+"&tabId="+tabId;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
    parent.isGraphExists();
}
...
coltypeDisp=coltypeDisp.toString().replace("-"," ");
 if((coltypeDisp.trim()=="(Running Total)")||(coltypeDisp.trim()=="(Rank)") ||(coltypeDisp.trim()=="(Rank ST)")){
    if(!isColumnPresent){
        $.ajax({
...
function statistics(columnName,disColumnName,tabId,type,ctxPath){
    ...
    var source = "TableDisplay/pbDisplay.jsp?sourceValue="+type+"&source=S&columnName="+columnName+"&disColumnName="+disColumnName+"&tabId="+tabId;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
...
function toprows(columnName,disColumnName,REPORTID,noofRows,ctxPath){
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=toprows&source=S&columnName="+columnName+"&topbottomCount="+noofRows+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
    parent.isGraphExists();
    }
...
function subTotalBottomRows(columnName,disColumnName,REPORTID,noofRows,ctxPath){
 ...
 function toprowsWithOthers(columnName,disColumnName,REPORTID,noofRows,ctxPath){
    ...
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=toprowsWithOthers&source=S&columnName="+columnName+"&topbottomCount="+noofRows+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
    parent.isGraphExists();
}
...
function rounding(columnName,disColumnName,REPORTID,precision){
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=rounding&source=S&columnName="+columnName+"&precision="+precision+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
}
...
function bottomrows(columnName,disColumnName,REPORTID,noofRows,ctxPath){
    ...
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=bottomrows&source=S&columnName="+columnName+"&topbottomCount="+noofRows+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
    parent.isGraphExists();
...
function topRowsPercentWise(columnName,disColumnName,REPORTID,noofRows,ctxPath){
    ...
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=toprowsPercent&source=S&columnName="+columnName+"&topbottomCount="+noofRows+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
...
function bottomRowsPercentWise(columnName,disColumnName,REPORTID,noofRows,ctxPath){
    ...
    var source = "TableDisplay/pbDisplay.jsp?sourceValue=bottomrowsPercent&source=S&columnName="+columnName+"&topbottomCount="+noofRows+"&disColumnName="+disColumnName+"&tabId="+REPORTID;
    var dSrc = document.getElementById("iframe1");
    dSrc.src = source;
...
var selectedcheck;
function MutliCalender(ctxpath,reportid,elements,tableid,factdetails){
