         ...
         <form name="loginForm" action="" method="post">
            <table class="upperTab" width="100%">
                <tr>
                    <td valign="top" style="height:30px;width:10%;">
                        <img width="100px" height="30px"  title="pi " src="<%=request.getContextPath()%>/images/pi_logo.gif"/>
                    </td>
                    <td valign="top" style="height:30px;width:80%" >

                    </td>
                    <td valign="top" style="height:30px;width:10%;" >
                        <img width="100px" height="30px"  title="Progen Business Solutions" src="<%=request.getContextPath()%>/images/ProGen_Logo.jpg"/>
                    </td>
                </tr>
            </table>
            ...
            <div class="white_content">
                ...
                <table width="100%" align="center">
                    <tr style="width:100%">
                        <td>
                            <font style="font-family:verdana;font-size:20px;color:red">Invalid Report Access .....</font>
                        </td>
                    </tr>
                 <%--   <tr><td>
