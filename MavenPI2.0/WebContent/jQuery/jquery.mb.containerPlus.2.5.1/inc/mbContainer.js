...
(function($){
  jQuery.fn.buildContainers = function (options){
    return this.each (function (){
      ...
      if (container.attr("width")){
        var cw= checkBrowser() == "ie"? container.attr("width"):container.attr("width")+"px";
  ...
  jQuery.fn.containerResize = function (){
    ...
    container.resizable({
      ...
      stop:function(){
        var resCont= $(this);//checkBrowser() == "ie" || Opera ?o.helper:
  ...
  jQuery.fn.containerSetButtons = function (buttons,opt){
    ...
    if (buttons !=""){
      ...
      var fadeOnClose=checkBrowser() == "firefox" || checkBrowser() == "safari";
