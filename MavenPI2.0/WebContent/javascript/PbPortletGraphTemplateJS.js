...
function dispParameters(params){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=dispParameters&params='+params+'&REPORTID='+document.getElementById("REPORTID").value,
...
function buildParams(){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildParams&params='+params+'&foldersIds='+buildFldIds()+'&paramNames='+paramNames+'&REPORTID='+reportID,
        success: function(data) {
        }
    });
}
...
function  dispTable(){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=dispTable'+'&REPORTID='+reportID,
        success: function(data){
            if(data!=""){
...
function sortOption(){
 ...
 var tabDiv=document.getElementById("sortDiv");
...
function setSortOrder(sortlevel){
              var tabDiv=document.getElementById("sortDiv");

             var  portletId=$("#REPORTID").val()
                 $.ajax({
                    url: "portalViewer.do?portalBy=setSortOrder&portletId="+portletId+'&sortlevel='+sortlevel,
                    success: function(data){
                       tabDiv.style.display='none';
                    }
                });
 ...
 function applyFilter(){
     var  portletId=$("#REPORTID").val()
      $("#applyFilterDiv").dialog('open')
      $("#filterIframe").attr("src","ruleHelp.jsp?fromModule=PORTAL&portletId="+portletId)
     alert("portalId\t"+portletId)
 }
