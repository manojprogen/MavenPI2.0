...
//added by santhosh.kumar@progenbusiness.com on 17-11-2009
...
function dispParameters(params){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=dispParameters&params='+params+'&REPORTID='+repotId,
...
function showMeasures(){
    ...
    var source="reportTemplateAction.do?templateParam=getMeasures&foldersIds="+parent.buildFldIds()+'&REPORTID='+repotId;
    //var paramUl=document.getElementById("sortable");
    //var paramIds=paramUl.getElementsByTagName("li");
    if(prevREPIds!=""){
...
function buildParams(dimId){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildParams&dimId='+dimId+'&params='+params+'&timeparams='+timeparams+'&foldersIds='+buildFldIds()+'&paramNames='+paramNames+'&REPORTID='+repotId,
        success: function(data) {
        }
    });
}
...
function dispParameters(){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=dispParams&params='+params+'&paramNames='+paramNames+'&REPORTID='+repotId,
        success: function(data) {
            if(data!=""){
...
function getRowEdgeParams(){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildTable&buildTableChange=REP&rowEdgeParams='+rowEdgeParams+'&rowEdgeParamsNames='+REPNames+'&REPORTID='+repotId,
        success: function(data){
        }
    });
}
function getColumnEdgeParams(){
    ...
    if(chkCount==1 || chkCount==0){
        $.ajax({
            url: 'reportTemplateAction.do?templateParam=buildTable&buildTableChange=CEP&colEdgeParams='+colEdgeParams+'&colEdgeParamsNames='+CEPNames+'&REPORTID='+repotId,
            success: function(data){
...
function dispMeasures(){
    ...
    if(msrIds.length!=0){
        ...
        $.ajax({
            url: 'reportTemplateAction.do?templateParam=buildTable&buildTableChange=Measures&Msrs='+msrs+'&MsrsNames='+msrNameOnly+'&REPORTID='+repotId,
            success: function(data) {
                if(data!=""){
...
function getGraphName(name,typeValue){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildGraphs&gid='+graphCount+'&grptypid='+typeValue+'&graphChange=default&grpIds='+graphIds.substring(1)+'&REPORTID='+repotId,
        success: function(data){
...
function getColumns(currentGraphId,allGraphIds){
    ...
    var source = "pbgraphColumns.jsp?graphId="+currentGraphId+"&folderIds="+buildFldIds()+"&grpIds="+allGraphIds+'&REPORTID='+repotId;
    frameObj.src=source;
    frameObj.style.display='block';
    document.getElementById('fade').style.display='block';
}
...
function getUserDims(){
    ...
    //write code to get kpi columns for kpi table

    //document.getElementById("kpis").innerHTML="<center><img id=\"imgId\" src=\"images/ajax.gif\" align=\"middle\"  width=\"75px\" height=\"75px\"   ></center>";
    $.ajax({
        url: "portalViewer.do?portalBy=getPortletKpis&foldersIds="+foldersIds,
        success: function(data) {
            if(document.getElementById("kpis")!=null || document.getElementById("kpis")!=""){
                document.getElementById("kpis").innerHTML=data;
                $("#kpiTree").treeview({
                    animated:"slow"
//                    animated: "normal",
//                    unique:true
                ...
                var dragKpi=$('#kpis > li > ul > li > span')
                ...
                $(dropKpis).droppable({
                    ...
                    accept:'#kpis > li > ul > li > span',
                    drop: function(ev, ui) {
                        var kpi=ui.draggable.html();
                        createKpis(ui.draggable.html(),ui.draggable.attr('id'));
                    }
                });
                $("#kpiSortable").sortable();
                $("#kpiSortable").disableSelection();
            }
        }
    });
    //if(foldersIds!=""){
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=getUserDims&foldersIds='+foldersIds+'&REPORTID='+repotId,
        success: function(data) {
            if(data!=""){
                $("#userDims").html("");
                str=data;
...
function getBuckets(){
    ...
    // if(foldersIds!=""){
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=getBuckets&foldersIds='+foldersIds+'&REPORTID='+repotId,
        success: function(data) {
...
function  dispTable(){
    ...
    $.ajax({
        url: 'portalViewer.do?portalBy=dispPortletKPITable&PORTLETID='+repotId,
        success: function(data){
            //
            if(data!=""){
...
function previewGraphs(){
    ...
    if(paramIds.length!=0){
        ...
        parentDiv.innerHTML='<center><img id="imgId" src="images/ajax.gif" align="middle"  width="75px" height="75px"  style="position:absolute" ></center>';
        $.ajax({
            url: 'reportTemplateAction.do?templateParam=refreshGraphs'+'&REPORTID='+repotId,
            success: function(data){
                parentDiv.innerHTML=data;
            }
        });
...
function changeGrpType(grpTypeId,grpId,graphIds){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildGraphs&gid='+grpId+'&grptypid='+grpTypeId+'&graphChange=GrpType&grpIds='+graphIds+'&REPORTID='+repotId,
        success: function(data){
            parentDiv.innerHTML=data;
        }
    });
...
function changeGrpSize(grpSizeId,grpId,graphIds){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildGraphs&gid='+grpId+'&grpsizeid='+grpSizeId+'&graphChange=GrpSize&grpIds='+graphIds+'&REPORTID='+repotId,
        success: function(data){
            parentDiv.innerHTML=data;
        }
    });
...
function deleteGraph(graphId,GraphIds){
    ...
    if(res){
        parentDiv.innerHTML='<center><img id="imgId" src="images/ajax.gif" align="middle"  width="75px" height="75px"  style="position:absolute" ></center>';
        $.ajax({
            url: 'reportTemplateAction.do?templateParam=buildGraphs&gid='+graphId+'&grpIds='+GraphIds+'&graphChange=DeleteGraph'+'&REPORTID='+repotId,
            success: function(data){
                parentDiv.innerHTML=data;
            }
        });
...
function getGraphDetails(currentGraphId,allGraphIds){
    ...
    frameObj.src='<center><img id="imgId" src="images/ajax.gif" align="middle"  width="75px" height="75px"  style="position:absolute" ></center>';
    var source = "PbGraphDetails.jsp?graphId="+currentGraphId+"&grpIds="+allGraphIds+'&REPORTID='+repotId;
    frameObj.src=source;
    frameObj.style.display='block';
    document.getElementById('fade').style.display='block';
}
...
//portlet kpi table related code by santhsh.kumar@progenbusiness.com on 17-11-2009

function createKpis(kpiName,elmntId){
    var i=0;
    var parentUL=document.getElementById("kpiSortable");
    ...
    if(kpiArray.length<1){
        ...
        alert("You can select maximum of one kpi")
    }
    $("#sortable").sortable();
    $("#sortable").disableSelection();
}
...
function buildPortletKPIS(){
    var kpis="";
    var kpiUl=document.getElementById("kpiSortable");
    ...
    if(kpiIds.length!=0){
        kpis=kpis.substr(1);
        $.ajax({
            url: 'portalViewer.do?portalBy=buildPortletKPIS&Kpis='+kpis+'&PORTLETID='+repotId,
            success: function(data) {
            }
        });
    }
