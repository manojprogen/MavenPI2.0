...
function showMeasures(){
    ...
    var source="reportTemplateAction.do?templateParam=getMeasures&foldersIds="+parent.buildFldIds()+'&REPORTID='+reportID;
    //var paramUl=document.getElementById("sortable");
    //var paramIds=paramUl.getElementsByTagName("li");
    if(prevREPIds!=""){
...
function buildParams(dimId){
    ...
    $.ajax({
        url: 'reportTemplateAction.do?templateParam=buildParams&dimId='+dimId+'&params='+params+'&timeparams='+timeparams+'&foldersIds='+buildFldIds()+'&paramNames='+paramNames+'&REPORTID='+reportID,
        success: function(data) {
        }
    });
}
...
function  dispTable(){
    ...
    $.ajax({
        url: 'portalViewer.do?portalBy=dispPortletKPITable&PORTLETID='+document.getElementById("REPORTID").value,
        success: function(data){
            //
            if(data!=""){
...
function buildPortletKPIS(){
    ...
    if(kpiIds.length!=0){
        kpis=kpis.substr(1);
        $.ajax({
            url: 'portalViewer.do?portalBy=buildPortletKPIS&Kpis='+kpis+'&PORTLETID='+reportID,
            success: function(data) {
            }
        });
    }
