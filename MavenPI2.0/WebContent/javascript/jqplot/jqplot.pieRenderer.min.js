...
//   modified by Kruthika on 11/11/14 to include values less than 3%
//     if(this.showDataLabels&&z[W][2]*100>=this.dataLabelThreshold){
    if(this.showDataLabels){
        ...
        if(this.dataLabels=="label"){
            ...
            if(this.dataLabels=="custom"){
                    F = this.dataLabelFormatString || '%d%%';
                           T=e.jqplot.sprintf(F,this.data[W][1])
                         T1 =  (' ' + ( z[W][2]*100).toFixed(2) + '% ');
...
var v =e("</br><div class='jqplot-pie-series jqplot-data-label' style='position:absolute;' > " +T1+" </div>").insertBefore(o.eventCanvas._elem);
