        ...
        function n(e,n){
            if(e){
                if(o(e))n||(f=function(){
                    ...
                    var t,n=0;
                    for(t in e)e.hasOwnProperty(t)&&n++;return n
...
if(o(e))i(e,0,f,0);
else if(C(e))for(s=0;s<e.length;s++)l=e[s],o(l)?i(l,0,f,0):C(l)?d(l):Object(l)===l&&c(l,f);else Object(e)===e&&c(e,f)
    ...
    p.src=e;
    for(f in r)p.setAttribute(f,r[f]);n=l?c:n||a,p.onreadystatechange=p.onload=function(){
    ...
    for(l in r)o.setAttribute(l,r[l]);i||(h.parentNode.insertBefore(o,h),m(n,0))
    }
