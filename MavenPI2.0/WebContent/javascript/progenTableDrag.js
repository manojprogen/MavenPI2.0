...
dragtable = {
  ...
  init: function() {
    ...
    forEach(document.getElementsByTagName('table'), function(table) {
      if (table.className.search(/\bprgtable\b/) != -1) {
 ...
 absolutePosition: function(elt, stopAtRelative) {
  ...
  dragStart: function(event, id) {
    ...
    if(dragObj.startCol == -1 || dragObj.startCol<=(parseInt(document.getElementById("viewBysCount").value)-1)){
        return
    }
  
   //if (dragObj.startCol == -1 || dragObj.startCol==0 || dragObj.startCol<=parseInt(document.getElementById("viewBysCount").value)-1) return;
  ...
  dragEnd: function(event) {
    ...
    var dropView = parseInt(document.getElementById("viewBysCount").value)-1;
    if(targetCol <= dropView){
            return;
        }
