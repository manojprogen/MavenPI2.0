...
<html>
	...
	<link rel="stylesheet" href="css/font-awesome.min.css" type="text/css"/>
        ...
        <link type="text/css" href="<%=request.getContextPath()%>/stylesheets/themes/<%=session.getAttribute("theme")%>/jquery-ui-1.7.3.custom.css" rel="stylesheet" />
...
<!-- Added by prabal-->
<link type="text/css" href="<%=request.getContextPath()%>/stylesheets/pageCss/landingPage.css" rel="stylesheet" >
    ...
    <form name="searchForm" action="landingPage.jsp" id="reportForm" method="POST"  >
      <button value="false" style="display: none" id="hidbtn">click</button>
         ...
         <div class="my-container-fluid">     
             <div class="col-xs-12 col-sm-12 rmpd rmmg" style="height: 12px;z-index: 103;">
                 <div id="sequenceSettingDiv">
                   ...
                   <ul id="sequenceConfigList" class="dropdown-menu" onmouseleave="javascript:($(this).hide())">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"><%=TranslaterHelper.getTranslatedInLocale("Change_Tag_Font", cL)%> </a>
                        <ul class="dropdown-menu">
                            <li><a style="font:12px inherit"  onclick="changeFont('Small')"><%=TranslaterHelper.getTranslatedInLocale("Small", cL)%></a></li>
                            <li><a style="font:14px inherit" onclick="changeFont('Medium')"><%=TranslaterHelper.getTranslatedInLocale("Medium", cL)%></a></li>
                            <li><a style="font:16px inherit" name="chart1" onclick="changeFont('Large')"><%=TranslaterHelper.getTranslatedInLocale("Large", cL)%></a></li>
                        </ul>
                   </li>
                   </ul>
             </div>
       ...
       var dateString="";
        ...
        var ReportDescription;
         ...
         function showConfigList(){
             if($("#sequenceConfigList").is(":visible")){
                 $("#sequenceConfigList").css("display","none");
             }else{
                 $("#sequenceConfigList").css({'display':'block','position':'relative','margin':'10px -35px','float':'right'});
             }
         } 
                               ...
                               $("#d1").append("<div class='col-xs-10 col-sm-10 rmpd' style='top: 40%; left: 10%;  box-shadow: 2px 2px 5px 4px rgb(209, 209, 209);'> <h3 style='margin-left: 20px;'>There is no  Reports are assigned to you.</h3></div>");
                                ...
                                for(var i=0;i<reportId.length;i++){
                                     ...
                                     if(layoutText=='Description')
                                    {
                                     ...
                                     var tileFontSize =($(window).width()*.02);
                                        if(tileFontSize>=18){tileFontSize=18; }
                                        var subtileFontSize =($(window).width()*.014);
                                        if(subtileFontSize>=20){subtileFontSize=20; }
                                         var addSize=3;
                                         var padding=20;
                                     createdDate="";
                                     updatedDate="";
    ...
    //                                     alert(demo)
                                         if(dateundefined=='undefined' || dateundefined===undefined)
                                           {   createdDate="";
                                            ...
                                            if((scHeight)*(0.225)<=130 && (scHeight)*(0.225)>115){addSize=0;padding=25;}
                                            if((scHeight)*(0.225)<=115){ addSize=4;padding=5;}
                                            ...
                                            div+="<div  id='updatedDate"+i+"' title='"+tagLongDesc[i]+"' style='padding-top: "+padding+"px; ' class='var-date-div'>Last Updated :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+updatedDate+"</span> </div>";
                                             div+="<div id='createdDate"+i+"' title='"+tagLongDesc[i]+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div>  ";
                                             if(tagLongDesc[i].length>100){
                                               div+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i].substring(0, 100)+"...</div></div></div>";
                                             }else{
												 div+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i]+"</div></div></div>"; 
											 }
                                            if(i>8 && i<=17){
                                                var div1="";
                                                if(tagType[i]=="R"){
                                              ...
                                              div1+="<div id='createdDate"+i+"' title='"+tagLongDesc[i]+"' style='padding-top: 10px; '  class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div>  ";
                                             if(tagLongDesc[i].length>100){
												 div1+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i].substring(0, 100)+"...</div></div></div>"; 
											 }else{
												 div1+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i]+"</div></div></div>"; 
											 }
                                            ...
                                            }else if(i>17)
                                            {
                                                ...
                                                if(tagType[i]=="R"){
                                                 ...
                                                 div2+="<div id='createdDate"+i+"' title='"+tagLongDesc[i]+"' style='padding-top: 10px; '  class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div> ";
                                                 if(tagLongDesc[i].length>100){
												 div2+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i].substring(0, 100)+"...</div></div></div>";
											 }else{
												div2+="<div id='Description'"+i+"' title= '"+tagLongDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+tagLongDesc[i]+"</div></div></div>";
											 }
        ...
        function checkPie(fontSize1){    
             ...
             $("#svgContain").html("");
                   $.post('<%=request.getContextPath()%>/reportViewer.do?reportBy=getDataCall&userId=<%=userid%>',
                    function(data){
                        ...
                        var leftMenuDivHtml="<div style='margin: 10px 0px; overflow-y: auto; height: 100%;'>";
                            <%if(favourit_Report_Tag.equalsIgnoreCase("true")){%>
                                leftMenuDivHtml+= "<div class='svgContain' id='favorite' onclick='displayFavReports(this.id)'  style='font-size:"+fontSize+";'  title='My Favourite Reports'  >My Favorites</div>";
                            <%}%>
                          <%if(recentRepAsTag.equalsIgnoreCase("true")){%>
                                leftMenuDivHtml+= "<div class='svgContain' id='recentalyReports' onclick='displayFavReports(this.id)'  style='font-size:"+fontSize+";'  title='Most Recently Accessed'  >Most Recently Accessed</div>";
                          <%}%>
                        ...
                        for(var i=0;i<data1.length;i++)
                          {
                            ...
                            tagNameS.push(data1[i]["Region"]);
                             if(data1[i]["Id"]==selectedVar){
                                leftMenuDivHtml+=" <div class='svgContain myActive' onclick='displayReports(this.id)' style='font-size:"+fontSize+";'   title='"+data1[i]["Region"]+"' id='"+data1[i]["Id"]+"' >"+data1[i]["Region"]+"</div>";                 
                             }else{
                                leftMenuDivHtml+=" <div class='svgContain ' onclick='displayReports(this.id)' style='font-size:"+fontSize+";'   title='"+data1[i]["Region"]+"' id='"+data1[i]["Id"]+"' >"+data1[i]["Region"]+"</div>";      
                           } 
                       }
			 <%if(customReportFlag.equalsIgnoreCase("true")){%>
                                leftMenuDivHtml+= "<div class='svgContain' id='customReports' onclick='displayFavReports(this.id)'  style='font-size:"+fontSize+";'  title='Custom Reports'  >Custom Reports</div>";   
                          <%}%>
                         ...
                         <%if(selectedLandingTag!=null && !selectedLandingTag.isEmpty()){%>
                          ...
                          <%}else if(favourit_Report_Tag.equalsIgnoreCase("true")){%>
            ...
            function displayFavReports(tagId){
                 ...
                 enableNext();
             $.ajax({ type: 'get',
                     url:'<%=request.getContextPath()%>/reportViewerAction.do?reportBy=currentSelectedTag&tagId='+currentSelectedTagId,
...
//                                      contentType: "application/json; charset=utf-8",
                                      ...
                                      success:function(data) {
                                            ...
                                            for(var i=0;i<data1.length;i++){ favReps(data1,i,dateString1);}
                                            },
      ...
      function DisplayRecentlyUsedReport(reportDes,reportNam,repotId,createdDat,updatedDat){
          ...
          for(var i=0;i<reportId.length;i++){
            ...
            if(updated===null||updated===undefined)updated="";
                 ...
                 div+="<div id='createdDate"+i+"' title='"+reportName[i]+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+created+"</span> </div>  ";
                 if(reportDesc[i].length>100){
				div+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i].substring(0, 100)+"...</div></div></div>";	 
				 }else{
				div+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i]+"</div></div></div>";	 
				 }
            ...
            if(i>8 && i<=17){
                 var div1="";
                  ...
                  div1+="<div id='createdDate"+i+"' title='"+reportName[i]+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+created+"</span> </div>  ";
                  if(reportDesc[i].length>100){
				div1+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i].substring(0, 100)+"...</div></div></div>";	 
				 }else{
				div1+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i]+"</div></div></div>";	 
				 }
                   $("#d2").append(div1);
             }else if(i>17)
             {
                 ...
                 div2+="<div  id='updatedDate"+i+"' title='"+reportName[i]+"' style='padding-top: "+padding+"px; ' class='var-date-div'>Last Updated :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+updated+"</span> </div>";
                  div2+="<div id='createdDate"+i+"' title='"+reportName[i]+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+created+"</span> </div>  ";
                  if(reportDesc[i].length>100){
				div2+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i].substring(0, 100)+"...</div></div></div>";	 
				 }else{
				div2+="<div id='Description'"+i+"' title= '"+reportDesc[i]+"' style='padding-top:5px;font-size:smaller' >"+reportDesc[i]+"</div></div></div>";	 
				 }
                 $("#d3").append(div2);
             }
             else{
         ...
         function favReps(data1,i,dataValue){
              $("#slider").css("left","0px");
                 C=0; 
                    var reportId=data1[i]["ID"];
                    var reportName=data1[i]["NAME"];
                    var REPORTDESC = data1[i]["REPORTDESC"]
                    var div = "";
                     if(data1.length>9){
                                $("#prev").css('display', '');
                                $("#next").css('display', '');
                    ...
                    if((scHeight)*(0.225)<=115){ addSize=4;padding=5;}
                     ...
                     div+="<div  id='updatedDate"+i+"' title='"+reportName+"' style='padding-top: "+padding+"px; ' class='var-date-div'>Last Updated :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+updatedDate+"</span> </div>";
                       div+="<div id='createdDate"+i+"' title='"+reportName+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div>  ";
                      if(REPORTDESC.length>100){
				 div+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC.substring(0, 100)+"...</div></div></div>";	 
				 }else{
				 div+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC+"</div></div></div>"; 
				 }
                        ...
                        div1+="<div  id='updatedDate"+i+"' title='"+reportName+"' style='padding-top: "+padding+"px; ' class='var-date-div'>Last Updated :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+updatedDate+"</span> </div>";
                         div1+="<div id='createdDate"+i+"' title='"+reportName+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div>  ";
                        if(REPORTDESC.length>100){
				 div1+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC.substring(0, 100)+"...</div></div></div>";	 
				 }else{
				 div1+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC+"</div></div></div>"; 
				 }
                                               $("#d2").append(div1);
                                            }else if(i>17)
                                            {
                        ...
                        div2+="<div  id='updatedDate"+i+"' title='"+reportName+"' style='padding-top: "+padding+"px; ' class='var-date-div'>Last Updated :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+updatedDate+"</span> </div>";
                         div2+="<div id='createdDate"+i+"' title='"+reportName+"' style='padding-top: 10px; ' class='var-date-div'>Created :&nbsp&nbsp&nbsp&nbsp<span style=' font-weight: 300;font-size: inherit;font-family: inherit;line-height: 1;'>"+createdDate+"</span> </div>  ";
                         if(REPORTDESC.length>100){
				 div2+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC.substring(0, 100)+"...</div></div></div>";	 
				 }else{
				 div2+="<div id='Description'"+i+"' title= '"+REPORTDESC+"' style='padding-top:5px;font-size:smaller' >"+REPORTDESC+"</div></div></div>"; 
				 }   
                                                $("#d3").append(div2);
...
//                                      C = (this.id=='next' ? ++C : --C) <0 ? N-1 : C%N;
                                    C++;  $sli.stop().animate({left: -C*wid2 },800);
                            }else{
                                     disableNext();
                                 }
                                  if($("#d3").html()==""){
...
//          },1000); 
        ...
        function changeSeq(){
                ...
                $("#addDynamic").html(htmlVar2);
                  $("#changeSequence1").css("background-color","#fff");
    ...
    <div id="changeSequence1" style="display:none;" title="<%=TranslaterHelper.getTranslatedInLocale("Change_Sequence", cL)%>">
        <form action="javascript:void(0)" name="sequenceForTag" id="sequenceForTag" method="post" onsubmit="return changeSequence1Tab()">
            ...
            <div style="width:20%;margin-left: auto;margin-right: auto;margin-top:5%;">
                 <input class="navtitle-hover btn-custom" style="width:auto" type="submit" value="<%=TranslaterHelper.getTranslatedInLocale("save", cL)%>" >
            </div>
        </form>
    </div>
