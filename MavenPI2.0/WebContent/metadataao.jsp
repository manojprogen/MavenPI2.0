...
//
                ...
                $.ajax({
                    url: "reportTemplateAction.do?templateParam=loadAOUIComponents",
                 ...
                 var data='<%=itemList%>'
               var length= bulidTable(data,'tablesorterReport','AO','<%=request.getContextPath()%>','<%=themeColor%>')
               $("#allReps").val(length);
                          var options, a;
                options = {
                    serviceUrl:'studioAction.do?studioParam=autoSuggest&tab=AO&userId=<%=userId%>',
            ...
            <table  border="0px solid" width="100%">
                <tr valign="top">
                    ...
                    <td align="right" width="50%">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <input type="button" value="Go" class="navtitle-hover" style="width:auto"  onclick="javascript:goToSelectedAOComponent('<%=request.getContextPath()%>')">
