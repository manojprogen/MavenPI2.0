...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.ListIterator,utils.db.ProgenParam,com.progen.action.UserStatusHelper,com.progen.users.UserLayerDAO,com.progen.reportdesigner.db.ReportTemplateDAO,prg.db.PbReturnObject,com.progen.report.display.DisplayParameters,com.progen.i18n.TranslaterHelper,prg.db.OnceViewContainer"%>
<%@page import="java.awt.*,java.util.Locale,java.util.List,java.util.ArrayList,java.util.Date,com.progen.timesetup.CalenderFormTable,java.util.Calendar,java.text.SimpleDateFormat,java.util.HashMap,java.util.Set,java.util.HashSet,java.util.Iterator"%>
...
session.setAttribute("viewByIdsSeq", viewByIdsSeq);
session.setAttribute("viewByNamesSeq", viewByNamesSeq);
...
<!--        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/stylesheets/tablesorterStyle.css" />-->
        ...
        <script type="text/javascript" src="<%=contextPath%>/javascript/queryDesign.js"></script>

        <script src="<%=contextPath%>/javascript/jquery.simplemodal-1.1.1.js" type="text/javascript"></script>
        <script src="<%=contextPath%>/javascript/jquery.contextMenu.js" type="text/javascript"></script>
...
<!--        <script src="<%=request.getContextPath()%>/javascript/treeview/jquery.treeview.js" type="text/javascript"></script>-->
        ...
        <SCRIPT type="text/javascript" SRC="<%=contextPath%>/javascript/overlib.js">  </SCRIPT>
...
<!--        <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/quicksearch.js"></script>-->
        ...
        <script type="text/javascript" src="<%=contextPath%>/tablesorter/addons/pager/jquery.tablesorter.pager.js"></script>
        <script type=""  language="JavaScript" src="<%=contextPath%>/tablesorter/jquery.columnfilters.js"></script>
...
<!--          <link rel="stylesheet" type="text/css" href="css/d3/xtendChart.css"/>-->
...
<!--        <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/quicksearch.js"></script>-->
        ...
        <script type="text/javascript">
            ...
            $("#regionTableId").height($(window).height());
//            $("#regionTableId").height("20000px);
...
//
    ...
    <body>
        ...
        <form name="frmParameter" id="" method="POST" action="">
            <table   id="showNameId" style="height:auto;display:none; padding-top: 1.5em">
                <tr>
...
<!--                    <td id="refreshId"  style="display: none" ><a class="ui-icon ui-icon-refresh" style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;font-size: 9pt;" title="Reset" onclick="viewOneBy(oneviewName, oneviewID)" href="#"></a></td>-->
               ...
               <td id="addregionsid" style="display: none" ><a href="javascript:void(0)" onclick="addRegioninViewer(oneviewID)" title="Add Region" class="ui-icon ui-icon-plusthick" title="Add Regions"></a></td>
                ...
                <div id="globalDiv" style="width: 100%; display: none;">
                    </div>
            ...
            <div id="divIdTest1" style=" height: 100px; border-width: 4px; border-style: groove; border-color: skyblue; margin-top: auto; margin-left: 10px; margin-right: 10px;  padding-bottom: 400px; padding-left: 100px;overflow: auto; "> &nbsp;
                ...
                <div id="divIdTest" style=" height: 100px;  margin-top: auto; margin-right: 200px;  padding-bottom: 370px; padding-left: 100px;"> &nbsp;
                    ...
                    <table id="tablesorterReport" class="tablesorter" cellspacing="1" cellpadding="0" border="0px solid" align="left"  width="100%" style="">
                        ...
                        <thead>
                            <tr>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("One_View_Name", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("Created_On", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("Created_By", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("Last_Modified_Date", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("Last_Modified_By", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("roles", cle)%></th>
                                <th align="left" class="header" nowrap=""><%=TranslaterHelper.getTranslatedInLocale("Options", cle)%></th>
...
<!--                                             <td valign="top"> <a  href="javascript:void(0)" class="ui-icon ui-icon-disk"  title="Schedule one view" onclick="scheduletheoneview('<%=viewByIds.get(i)%>','<%=viewByNames.get(i)%>')"></a></td>-->
                        ...
                        <div id="AddMoreParamsDiv1" style="display:none" >
           <iframe  id="addmoreParamFrame1" name='addMoreParamFrame1' width="100%" height="100%" frameborder="0"   src='about:blank'></iframe>
        </div>
            ...
            <div id="designId" style=" width: 100%; margin-right: 1%;  padding-bottom: 0px;margin-top: -30px; display: none"> &nbsp;
<!--                              <table id="paraminfoId" align="right"><tr><td><span style='color:red;'>*</span> Press <b>Go</b> for Saving/Refresh</td></tr></table>-->
                <div align="left" id="regionTableId"   style="width:100%;position:absolute;">
                     <div class="tooltip" id="my_tooltip" style="display: none"></div>
                    <iframe    height="100%" width="100%" frameborder="0" id="regionTableIdgrid" scrolling="yes"></iframe>
...
<!-- <div id= "listofgraphs"  style=' display: none; position:absolute;height:1000px; width:20%; top:92%; right:2px; border: 1px solid skyblue; overflow-y:auto; background-color: white;direction:ltr;z-index: 1000;float: right'></div>-->
<!-- edited by MANIK-->
 <div id= "listofgraphs"  style=' display: none; position:absolute; width:20%; top:140%; right:2px; border: 1px solid skyblue; overflow-y:auto; border-radius: 1px 30px; background-color: rgb(51, 98, 119);direction:ltr;z-index: 1000;float: right'></div>
...
<!--                edited by manik-->
<table style="background-color: rgb(51, 98, 119); color: white;" >
<!--                    <tr>
<td><input type="radio" id="oneviewTime" style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;"  onclick="settimeto()" checked=''   >Oneview Time</td>
                    <td><input type="radio" id="reportTime" style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;"  onclick="settimetoreport()" valign="top"   >Report Time</td> </tr>-->
                    <tr>
                        <td id="busNamId"  >Select the Role :</td></tr>
                    <tr>
                        <td id="busroleTdId"  >
...
<!--                        Edited by manik-->
                        <td  width="1%" ><a class="ui-icon ui-icon-circle-triangle-s" style="background-color: white;text-decoration:none" onclick="hideaddreport()"  title="remove listofgraphs" href="javascript:void(0)">
</a></td>
                    </tr>
                </table>
                            <div >
                <table width="100%" id="repDialogTest" style="background-color: rgb(51, 98, 119); color: white;">
...
<!--                 <table id="oneviewrange" style="display: none;"><tr> <td class="myhead">select Date Type:</td>
                ...
                <table width="100%">
                    <tbody>
                        <tr>
                            <td align="center">
                                <input class="navtitle-hover" onclick="insertNamegrid()" type="button"  value=" Done ">
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<!--Added By Ram-->
<div id="oneViewlist1" style='display: none;position:relative;margin-top:4em; right:0px;text-align:left;background-color: white;border:1px solid #000000;direction:ltr;z-index: 1000;float: right; border-radius:4px 4px 4px 4px'>

    <div id='oneViewlist' title='select type' ><table id= 'typeOfReport' width='12%' align='center'  >
 <!--   <tr><td><a href='#' onclick="selectReadd1(1)">   Reports</a></td></tr>>-->
 <tr><td><a href='#' onclick="showreports()">   Reports</a></td></tr>
<!--<tr><td><a href='#' onclick="showmeasures()"> Measure</a></td></tr>-->
</table>
...
<!--                <div id="customTimeMsr1" style="display: none" title="Custom Time Aggregation">
                    <table>
                        <tr>
                            <td colspan="2">
  ...
  <form action="" method="POST" id="oneviewgraphForm">
                 ...
                 <input type="hidden" id="globalviewby" name="globalviewby"/>
                 <input type="hidden" id="globalviewbyIds" name="globalviewbyIds"/>
         <input type="hidden" id="graphName" name="graphName" value=""/>
            <input type="hidden" id="graphsId" name="graphsId" value=""/>
            <input type="hidden" id="regid1" name="regid1" value=""/>
            <input type="hidden" id="measure" name="measure" />
 <input type="hidden" name="measureIds" id="measureIds"/>
  <input type="hidden" name="oneviewVersion" id="oneviewVersion">
            ...
            <input type="hidden" id="filterdata" name="filterdata" />
            <input type="hidden" id="filterdata1" name="filterdata1" />
            <input type="hidden" id="gridsterobj" name="gridsterobj" />
            <input type="hidden" id="idArradhoc" name="idArradhoc" />
             <input type="hidden" id="filterMap" name="filterMap" />
            <input type="hidden" id="globalparams" name="globalparams" />
            <input type="hidden" id="globalparamsids" name="globalparamsids" />
            ...
            <input type="hidden" id="busroleid" name="busroleid" />
            <input type="hidden" id="drills" name="drills" />
            <input type="hidden" id="filters1" name="filters1" />
            <input type="hidden" id="viewbygblids" name="viewbygblids" />
            <input type="hidden" id="viewbygblname" name="viewbygblname" />
            <input type="hidden" id="driver" name="driver" />
            <input type="hidden" id="type" name="type" />
            <input type="hidden" id="rename" name="rename" />
            <input type="hidden" id="timedetails" name="timedetails" />
            <input type="hidden" id="drillFormat" name="drillFormat"  />
            <input type="hidden" id="adhocdrills" name="adhocdrills" />
...
<!--            added by manik-->
            <script>
                     $("#listofgraphs").height((screen.height)*.65);
                     var htmlcustom="";
                      $(document).ready(function(){
                      htmlcustom +="<input id='customMsrdate' class='ui-datepicker' type='text' size='15' value='' name='customMsrdate'></input>";
                      });
            </script>
 <script type="text/javascript">
            var change="";
                ...
                if(col<=6)
                {
                    ...
                    for(var i=prevRow;i<row;i++)
                    {
                        ...
                        for(var j=0;j<col;j++)
                        {
                            ...
                            {
                                var mergeColHtml="<a  onclick=\"mergeColumn("+tdId+","+col+","+width+")\" style='text-decoration:none;font-size:pt;' class=\"ui-icon ui-icon-arrowthick-2-e-w\" title=\"Merge Column\"></a>&nbsp";
                            }
                            if(i==row-1)
                            {
                                var mergeRowHtml="";
                            ...
                            {
                                var mergeRowHtml="<a  onclick=\"mergeRow("+tdId+","+col+")\"  style='text-decoration:none;font-size:20pt;' class=\"ui-icon ui-icon-arrowthick-2-n-s\" title=\"Merge Rows\">-</a>&nbsp";
                            }
                       ...
                       <% } %>regionHtml+="<div id=\"readdDivId"+tdId+"\" style='display:none;width:70px;height:auto;background-color:white;overflow:auto;position:absolute;text-align:left;border:1px solid #000000;' class='overlapDiv'>"
                                             regionHtml+="<table border='0' align='left' >"
                                                regionHtml+="<tr><td>"
                                                         ...
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('measures','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >Measures</a></td></tr></table>"
                                                         ...
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('dashboard','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >KPIs</a></td></tr></table>"
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('headline','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >Headlines</a></td></tr></table>"
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('complexkpi','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >Custom KPI</a></td></tr></table>"
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('notes','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >Notes</a></td></tr></table>"
                                                         regionHtml+="<table><tr><td><a href='javascript:void(0)' style='text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;' onclick=\"selectedType1('template','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" >Template</a></td></tr></table>"
                                                     regionHtml+="</td></tr>"
                                             regionHtml+="</table>"
                                             regionHtml+="</div>"
                            ...
                            regionHtml+="<tr ><td colspan='4' align='right'><div id='GrpType"+tdId+"' style='width: 70px; height: auto; position:relative;background-color: white; overflow: auto; text-align: left; border: 1px solid LightGrey;display: none;'>\n\
                                    ...
                                    "<tr ><td valign='top' ><a onclick=\"selectedType1('measures','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>Measures</a></td></tr>"+
                                "<tr ><td  ><a onclick=\"selectedType1('dashboard','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>KPIs</a></td></tr>"+
                                "<tr ><td  ><a onclick=\"selectedType1('headline','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>Headlines</a></td></tr>"+
                            "<tr ><td ><a onclick=\"selectedType1('complexkpi','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>Custom KPI</a></td></tr>"+
                            "<tr ><td  ><a onclick=\"selectedType1('notes','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>Notes</a></td></tr>"+
                            "<tr ><td  ><a onclick=\"selectedType1('FavReports','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>FavReports</a></td></tr>"+
                            "<tr ><td ><a onclick=\"selectedType1('template','Dashlets-"+tdId+"',"+tdId+","+width+","+height+",'Dashlets"+tdId+"','GrpTyp"+tdId+"','"+oneViewIdValue+"')\" href='javascript:void(0)'>Template</a></td></tr><tr><td></td></tr>"+
                        "</table> </div></td></tr>"
            ...
            $.ajax({
               ...
               success: function(data) {
                 alert(data)
                   ...
                   // alert(reportNamesforsending);
                  for(var i=0;i<json.length;i++)
                    {
                        favReportHtml+=" <table id='table"+json[i].reportId+"'  <tr> <td></td>";
 if(json[i].reportType=='R'){
     favReportHtml+="<td title='" + json[i].reportName + "'><a  href='reportViewer.do?reportBy=viewReport&REPORTID="+ json[i].reportId +"&action=open ' target='_blank'  style='color:#336699'>" + json[i].reportName + "</a> </td>";
 }else{
                               // alert("dash")
...
var  busrolename;
 ...
 var ch=1;
                          ...
                          graphId=  repId;
//                            alert("rep"+repId+"grp..."+graphId+"table..."+repId);
...
//                                //
                                ...
                                reporthtml+="<span style='font-family:verdana;font-size:8pt;color:#C9FC75;' onclick=\"dragGraph('" + repId + "')\">" + repName + "</span>";
...
//                                    repId = jsonVar.ReportIds[h];
                                graphId = jsonVar.ReportIds[i1];
                                 ...
                                 graphName = jsonVar.GraphNames[i1];
                                reporthtml+="<li class='closed' id='" + graphId + "'>";
                                //Added by Ram for different image for tiles
                                var ch1=graphName.charAt(0);
                                 var n = graphName.length;
                            if(ch1=='t'){
                                 reporthtml+="<img src='icons pinvoke/tile.PNG'></img>";
                               graphName = graphName.slice(1,n);
                            }
                             else
                                reporthtml+="<img src='icons pinvoke/chart.png'></img>";
                                if(graphName==null ||graphName==""||graphName=="null"){
                                    reporthtml+="<span id='graph-" + graphId + "' style='font-family:verdana;font-size:8pt'draggable='true' ondragstart='drag(event)' onmouseover= 'dragreport(" + repId + "," + graphId + ","+'"' + repName + '"'+","+first+","+ busroleId+","+first+","+'"' +oneViewIdValue+ '"'+","+'"' + chname + '"'+")'><a style='color:white' href='javascript:buildDbrdGraph(" + repId + "," + graphId + ","+'"' + repName + '"'+","+first+","+'"' + graphName + '"'+","+'"' + chname + '"'+")' >" + repName + "</a></span>";
                                }else{
                                reporthtml+="<span id='graph-" + graphId + "' style='font-family:verdana;font-size:8pt' draggable='true' ondragstart='drag(event)' onmouseover= 'dragreport(" + repId + "," + graphId + ","+'"' + repName + '"'+","+first+","+ busroleId+","+first+","+'"' +oneViewIdValue+ '"'+","+'"' + chname + '"'+")'><a style='color:white' href='javascript:buildDbrdGraph(" + repId + "," + graphId + ","+'"' + repName + '"'+","+first+","+'"' + graphName + '"'+","+'"' + chname + '"'+")' >" + graphName + "</a></span>";
                                }
...
//                                reporthtml+="<span id='reportName-" + repId + "' style='font-family:verdana;font-size:8pt'><a style='color:white' href='javascript:buildDbrdTable(" + repId + ","+'"' + repName + '"'+")' >" + repName + "</a></span>";
//                                reporthtml+="</li>";
                                 reporthtml+="</ul>";
                                    reporthtml+="</li>";
                        }
...
var VoneViewId=''
var chartid=''
            function dragreport(repId1,GraphId1,GraphName1,grpno1,busroleId1,isgraph,oneViewIdValue,chrtname)
{
VrepGraphId=GraphId1;
VrepId=repId1;
VrepGraphName=GraphName1;
chartid=chrtname;
Vgrpno=grpno1;
VbusRoleId=busroleId1;
VoneViewId=oneViewIdValue;
graphortable=isgraph;
$("#graphsId").val(repId1);
    $("#graphName").val(VrepGraphName);
    $("#chartname").val(chrtname);
...
// generateJsonDataOneview("null",oneViewIdValue,"null","null","add",gridster5);
...
//
//}
            function saveOneview(gridster,value){
                ...
                $("#busNamId").hide();
                $("#clearId").hide();
                var  oneviewVersion=$("#oneviewVersion").val();
...
//                value.innerHTML='<center><img id="imgId" width="200px" height="200px" src=\"<%=request.getContextPath()%>/images/ajax1.gif\" align="middle"  width="75px" height="75px"  style="position:absolute" ></center>';
                $.post('<%=request.getContextPath()%>/reportViewer.do?reportBy=saveingOneviews&reportBy=viewReport&action=save'+'&oneViewIdValue='+oneViewIdValue+'&datetype='+timeDetail+'&oneviewVersion='+oneviewVersion,
                function(data){
//return function(callback) {
//                    setTimeout(function() {
saveoneviewjsons(oneViewIdValue,gridster,"null")
...
//            var oneviewName='';
            ...
            var defultdate;
            var  datetype;
            function viewOneBy(name,idvalue){
...
//                        if(oneviewtypedate1=='true'){
  ...
  var dSrc = parent.document.getElementById("regionTableIdgrid");
                        var source="newOneView.jsp?fromopen=true&fromviewer=true&action=open&oneviewname="+name+"&oneViewIdValue="+idvalue;

                        dSrc.src = source;
//                        alert(gridster5)
//                        buildd3charts(idvalue,gridster5)
$("#footID").hide();
...
//                            alert('in loop');
            ...
            function submiturls12(url){
                ...
                document.frmParameter.action = url+'&isdrilltype=true'; //edited by manik
...
//                    document.getElementById(id).style.display='';
 ...
 function selectforReaddtoggle(id)
                         {


                             //alert("bfvhfbvfbb....."+id);
//
                     if(document.getElementById("readdDivId2"+id).style.display=='block'){
                        // alert("bfvhfbvfbb11....."+id);
                       // $("#readdDivId2"+id).toggle(500);
                      //$("#readdDivId2"+id).show();
                       }
                     //   $("#readdDivId2"+id).show();
                 //   $("#reigonOptionsDivId"+id).toggle(500);
...
var viewbyid=chartData[chartname]["viewIds"][0];
                    ...
                    var source ="OLAPGraph.jsp?reportId="+reportId+"&viewbyid="+viewbyid+"&graphId="+graphid+"&callFrom=oneView&graphNum="+graphnum+"&width="+(dialogWidth-50)+"&height="+(dialogHeight-50)+"&timeDetails="+timeDetails+"&isrepDate="+isrepDate+"&oneviewID="+oneviewID+"&regid="+regid+"&chartname="+chartname+"&repname="+dashletName+"&rolename="+rolename;
                    frameObj.src=source;
}
...
//            context.textAlign = getTextAlign($(this));
    ...
    function saveOneVIewReg(gridster){
        $.post('<%=request.getContextPath()%>/oneViewAction.do?templateParam2=versionCheck&oneViewIdValue='+oneviewID+'&oneviewName='+oneviewName,
         function(data){
             ...
             if(oneVersion=='1.0'||oneVersion=='1.1'){
                 ...
                 saveOneVIewReg1(gridster);
             }
         });
    }
 var value;
   function saveOneVIewReg1(gridster){
...
//                        document.getElementById("regionTableId").innerHTML=data;
                        $("#regionTableId").html(data);
//                         buildd3charts(oneviewID)
                         saveoneviewjsons(oneviewID,gridster,"true")
                         var dSrc = parent.document.getElementById("regionTableIdgrid");
                        var source="newOneView.jsp?action=save&fromviewer=true&oneviewname="+oneviewName+"&oneViewIdValue="+oneviewID;
