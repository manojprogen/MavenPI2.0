...
.ui-icon-closethick{background-image: url(stylesheets/themes/Green/images/ui-icons_d8e7f3_256x240.png);
    background-position: -96px -128px;}
          ...
          <script type="text/javascript">
                ...
                var source="reportTemplateAction.do?templateParam=addMoreDimensions1&foldersIds="+roleId+"&IsrepAdhoc="+IsrepAdhoc+"&REPORTID="+document.getElementById("REPORTID").value;
                frameObj.src=source;
...
#roundtrip {display:none;}
    ...
    <body>
     ...
     <div class="form clearFix">
      <span class="wr100">
       <table align="center" id="roundtrip" stylr="display:none;">
       <tr width="100%">
        <td align="right">
            <% if(sytm.equalsIgnoreCase("No")){ %>
                ...
                <form name="submitReportForm" id="submitReportForm" method="post" action="" style="display: none" >
                  ...
                  <table width="100%" height="100%" valign="top">
                      <tr><td style="width:1%" nowrap>
                          ...
                          <td> <a href="javascript:void(0)"  onclick="saveRepotInDesigner()"><img style=" height: 13px;width: 13px;margin-left: 20px;" alt="" title="Global Save" src="<%=request.getContextPath()%>/images/save.png"/></a>
                          </td></tr>
                      </table>
                          <table>
                      <tr>
...
<!--                          <td width="1%" title="Click Here To Hide Left Pane" style="background-color:#e6e6e6;border:0px;cursor:pointer" class="ui-corner-all"  >
                          ...
                          <td>
                  <table width="100%" height="100%" valign="top" style=" border-width: 4px; border-style: groove; border-color: skyblue;margin-left:6px;  ">
                      <tr >
...
<!--           <iframe  id="addmoreParamFrame" name='addMoreParamFrame' width="100%" height="100%" frameborder="0"   src='about:blank'></iframe>-->
             ...
             <table><tr><td> <select id ="ReportLayout" style="width:120px;display:none;" id="time" name="time">
<!--                            //added by Mohit for Custom setting-->
<!--                         <option id="st" onclick="timeBasis()">none</option>-->
...
<div align="center" id="desginerDiv" width="100%"  style="  height: 570px; border-width: 1px; border-style: none; border-color: grey;  ">
            ...
            <div align="center" id="desginerDiv11" width="100%"  style="  height: 577px; border-width: 1px; border-style: none; border-color: grey;  ">
