...
<%@page import="prg.db.Container,java.math.*,java.text.*,java.util.*,com.progen.report.DashletDetail,com.progen.report.KPIElement,com.progen.report.entities.KPI"%>
<%@page contentType="text/html" pageEncoding="UTF-8" import="prg.db.PbDb,utils.db.ProgenConnection,prg.db.PbReturnObject,com.progen.report.pbDashboardCollection,com.google.common.base.Joiner,com.progen.report.kpi.KPISingleGroupHelper" %>
...
<!--        <link type="text/css" href="<%=contextPath%>/stylesheets/metadataButton.css" rel="stylesheet" />-->
 ...
 //             kpielementnames = kpielementnames + kpiGroupElements;
            ...
            if (timeArray.get(1).toString().equalsIgnoreCase("PRG_STD")) {
                ...
                //dateSql = "select date(dd, convert(datetime,'"+ month.get(0) +"',101))";
                    dateSql ="select day(str_to_date('" + month.get(0) + "','%m/%d/%Y'))";
                }
                        else{
                    //str_to_date('" + ((String) details.get(0)) + "','%m/%d/%Y')
                    //to_date('" + ((String) details.get(0)) + "','mm/dd/yyyy'),null)
