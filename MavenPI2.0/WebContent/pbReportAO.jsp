<%-- 
    Document   : pbReportAO
    Created on : Dec 7, 2015, 12:16:50 PM
    Author     : bhargavi.parsi@progenbusiness.com
--%>

<%@page import="java.util.HashMap,prg.db.Container,java.util.ArrayList,prg.util.screenDimensions,com.progen.report.PbReportCollection,com.progen.action.UserStatusHelper,utils.db.ProgenParam,prg.db.PbReturnObject,com.progen.reportdesigner.db.ReportTemplateDAO"%>
<%@page contentType="text/html" pageEncoding="UTF-8" import="prg.db.PbDb,com.progen.report.display.DisplayParameters"%>
...
//                         params=displayParameters.designerParams(request.getContextPath());
                    ...
                    String aoid=(String)request.getAttribute("aoId");

                    request.setAttribute("isReportFromAO","true");
...
//                    grpTypeskeys = (String[]) GraphTypesHashMap.keySet().toArray(new String[0]);
                   ...
                   // out.println("reportName....."+reportName);
...
<!--        <script type="text/javascript" src="<%=contextPath%>/javascript/docs.js"></script>-->
	...
	<link rel="stylesheet" href="css/font-awesome.min.css" type="text/css"/>
        <link type="text/css" href="<%=contextPath%>/stylesheets/themes/<%=session.getAttribute("theme")%>/ui.dialog.css" rel="stylesheet" />
...
#center250b { width: auto;height: 65px;   background:none; }
            ...
            <script type="text/javascript">
              $(document).ready(function() {
                ...
                var frameObj=document.getElementById("addmoreParamFrameAO");

                var IsrepAdhoc='<%=IsrepAdhoc%>';
                var source="reportTemplateAction.do?templateParam=addMoreDimensionsAoReport&aoid="+<%=aoid%>+"&IsrepAdhoc="+IsrepAdhoc+"&REPORTID="+document.getElementById("REPORTID").value;
                frameObj.src=source;
        ...
        <select id="calPeriodYear" name="calPeriodYear" style="width:90px" onchange="saveyear2('perioddate')">
         ...
         <td> <input  type="hidden" id="datetext" name="datetext" value=""/></td>
          ...
          <td id="timebasistd"></td>
           <td id="saveTabId" ><a href="javascript:void(0)" style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;font-size: 9pt;" class="ui-icon ui-icon-disk" title="Global Save" onclick="saveRepotInDesignerAO()"></a></td>
...
<!--            <tr>
                <td style="font-size: 22px; color: black">
                   Custom Report Builder
                </td>
            </tr>-->
        </table>
                <form name="submitReportForm" id="submitReportForm" method="post" action="" style="display: none" >
...
<!--                          <table >
                      <tr>
                          ...
                          <td valign="top" style="width:3%;position: relative">
                             <a href="javascript:void(0)" class="fa fa-plus-square" onclick="AddMoreDims(<%=IsrepAdhoc%>)"></a>
                          </td>
                              <td  id="" valign="top" style="width:1%;position: relative;display: ''">
                             <a href="javascript:void(0)" class="fa fa-floppy-o" onclick="saveRepotInDesigner()"></a>
                          </td>
                          ...
                          <td id="AddGraphIcon" valign="top" align="center" style="width:10%;" valign="top">
                             ...
                             <div style="width:50%;padding:5px;font-size:16px">
                                <i onclick="AddMoreDims(<%=IsrepAdhoc%>);" style="cursor: pointer;" class="fa fa-plus-square"></i>&nbsp&nbsp
                                <i onclick="saveRepotInDesignerAO();"  style="cursor: pointer;" class="fa fa-floppy-o"></i>
                              </div>
                                 <!--ended  by prabal-->
...
<!--                                <div><img  alt="" id="tdImage" src="<%=request.getContextPath()%>/icons pinvoke/<%=String.valueOf(session.getAttribute("imageType"))%>.png"/></div>-->
                              <i id="tdImage" class="fa fa-chevron-circle-left"></i>
                            </td>
...
<!--                         <option id="RangeBasis" value="RangeBasis" onclick="timeBasis()" name="time">Range Basis</option>-->
                              ...
                              <td style="display:none;"><a class="ui-icon ui-icon-copy" title="Report Layout"></a></td>
                          <td style="display:none;">
                        <select id ="ReportLayout" style="width:120px">
<!--                            //added by Mohit for Custom setting-->
<!--                         <option id="st" onclick="timeBasis()">none</option>-->
                         <option selected  id="ViewBy" value="ViewBy"  name="ViewBy">ViewBy</option>
...
<input type="hidden" name="AOFlag" value="true" id="AOFlag">
...
<div align="center" id="desginerDiv" width="100%"  style="  height: 570px; border-width: 1px; border-style: none; border-color: grey;  ">

            <div align="center" id="desginerDiv11" width="100%"  style="  height: 570px; border-width: 1px; border-style: none; border-color: grey;  ">

            <iframe  id="addmoreParamFrameAO" name='addmoreParamFrameAO' width="100%" height="100%" frameborder="0"   src='about:blank'></iframe>
    ...
    if(dispgrptypObj.style.display=='none'){
        ...
        dispgrptypObj.style.display='none';
              ...
              function saveRepotInDesignerAO(){
                 // alert("hhhh")
...
//                                        function(data){{
                                          document.forms.submitReportForm.action = "reportTemplateAction.do?templateParam=saveReport&action=open&graphTableHidden="+graphTableHidden+"&cacheAo="+cacheAo+"&aoId="+<%=aoid%>;
