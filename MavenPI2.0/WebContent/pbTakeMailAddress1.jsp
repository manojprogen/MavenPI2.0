    ...
    self.close();
          ...
          parent.cancelMessage();
             ...
             function doSend1()
            {
                ...
                document.mymailsendForm.action = "pbSendMail.jsp";
                document.mymailsendForm.submit();
                 parent.cancelMessage1();
            }
            }
...
function sample()
{
 ...
 //document.mymailsendForm4.onsubmit = function(){return false;};
}
...
//alert("In state Changed ready state is 4"+xmlHttp.responseText);
 ...
 #wrapper { display: inline;}
    ...
    <body onLoad="document.mymailsendForm.toAddress.focus()" onblur="self.focus()">
        <%String path = request.getContextPath();%>
        <Form action=""  name=mymailsendForm method=POST>
            <br><br>    
            <table align="center"><tr><td>
               Please use @ for searching the database(incase of to whom you want to send mail).
            </td></tr></table>
            <Table width=60% border=0 align=center STYLE="border-width:thin;background-color:#CCCCCC">
                <Tr>
                    <Th colspan=2 style="border-style:outset;border-width:1px">Compose Message</Th>
                </Tr>
                <Tr>
                    <Th width=20% style="border-style:outset;border-width:1px">To</Th>
                    <Td width=80%><input type=text name=toAddress id="toAddress" autocomplete="off" size=80 onfocus="selId('toAddress','emaildiv','qq')"></Td>
                    
                </Tr>
                <Tr>
                    <th></th>
                    <td><div id="emaildiv"  style="height:200px;overflow:auto"></div></td>
                </Tr>
                <Tr>
                    <Th style="border-style:outset;border-width:1px">Subject</Th>
                    <Td style="border-style:outset;border-width:1px"><Input type="text" name="subject" id="subject" size="80"></Td>
                </Tr>
                <Tr>
                    <Td colspan="2" style="border-style:outset;border-width:1px"><Textarea class="textarea3" rows="5" name="bodyText" id="bodyText" cols="80"></Textarea> </Td>
                </Tr>
            </Table>
            <br>
            <Center>
             <%--   <input class="navtitle-hover" type=button name=Cancel  value=Cancel onClick="javascript:doCancel()">--%>
             <input class="navtitle-hover" type="button" name="Send" style="width: 50px" value="Send" onClick="javascript:doSend1()">
            </Center>
