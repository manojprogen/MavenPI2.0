...
<%@page contentType="text/html"  pageEncoding="UTF-8" import="com.progen.i18n.TranslaterHelper,java.util.Locale,com.progen.report.query.PbReportQuery,java.text.DecimalFormat,com.progen.reportview.bd.PbReportViewerBD"%>
...
<%@page import="prg.db.Container,com.progen.report.segmentation.Segment,com.progen.report.whatIf.WhatIfScenario,com.progen.graph.info.ProgenGraphInfo"%>
<%@page  import="java.awt.*,utils.db.*,java.io.*,java.util.*,com.progen.db.*,prg.db.DataTracker,prg.util.screenDimensions" %>
<%@page import="prg.db.*,prg.db.PbDb,prg.db.Session,prg.db.PbReturnObject,java.text.SimpleDateFormat,java.sql.*"%>
<%@page import="com.progen.report.PbReportCollection,com.progen.reportdesigner.db.DashboardTemplateDAO,com.progen.reportdesigner.db.ReportTemplateDAO" %>
...
<style type="text/css">
.loading_image{display:block;position:absolute;top:0;left:0;width:100%;height:170%;background-color:#000;z-index:1001;-moz-opacity:.5;opacity:.5;filter:alpha(opacity=50);z-index:1001;overflow:hidden}
...
<!--    <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/lib/jquery/js/jquery-ui-1.7.3.custom.min.js"></script>-->
    ...
    <script type="text/javascript" src="<%= request.getContextPath()%>/JS/reportgbl/jquery.ui.dialog.js"></script>
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/jQuery/d3/progenChartType.js"></script>
...
<!--        <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/ui.slider.js"></script>-->
        ...
        <script type="text/javascript">
            ...
            var isKPIDashboard1="";
            var fromReport="true";
            var ViewByArrayId=[];var ViewByArrayName=[];
            var filterMapNew={};
            var filterMapNotin={};
            var filterMapNewtb={};
            var filterMapgraphs={};
            ...
            $(function(){
                ...
                $("#moreCompanyDiv").dialog({
                 ...
                 window.onresize = function(event) {
                     ...
                     $("#iframe1").height($(window).height()-150);
...
var htmlSignature=$("input[name='htmlSignature2']:checked").val();
       ...
       function callFilterDiv() {
        ...
        <style>
            ...
            #datalist>table td a{color:#555;display:block}
        </style>
        <script>
            var fdate,cfdate;
            var fdate1,cfdate1;
...
<input height="100px" width="100px" type="hidden" id="perioddate" name="perioddate" onchange=""  onclick=""/>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div id="datalist"  class="hideAllDiv"  onmouseleave='hideme(id)' style="display:none;position:absolute;height:5%;float: right;">
                                                                    ...
                                                                    <!--Edited by Faiz Ansari-->
                                                                        ...
                                                                        <tr>
                                                                            <td id="showsql" style="width:100%;height:25px">
                                                                        ...
                                                                        <tr>
                                                                            <td><a class="gFontFamily gFontSize12" onclick="saveReportTagName()" href="javascript:void(0)"><%=TranslaterHelper.getTranslatedInLocale("Tag_Report", cL)%></a></td>
...
<!--                                                                            End!!!-->
        ...
        <div id="tableColsDialog" title="<%=TranslaterHelper.getTranslatedInLocale("Add_Measures", cL)%>" style="display:none" >
            <table><tr><td classs="gFontFamily gFontSize12">
...
<!--        added by sruthi for globalcolumn pro-->
        <div id="dispTabColumnProp" title="<%=TranslaterHelper.getTranslatedInLocale("Table_Column_Properties", cL)%>" style="display:none">
            <iframe id="dispTabColumnPropFrame" NAME='dispTabColumnPropFrame' width="100%" height="100%"  frameborder="0" SRC='about:blank'></iframe>
        </div>
<!--eneded by sruthi-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                function resizeGridDiv()
                {
                   ...
                   $("#gridsterDiv").css({"height": (viewPortHeight-255)+ "px"});
