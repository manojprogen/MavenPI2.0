<%--
    Document   : timebasedkpi
    Created on : Jun 13, 2015, 11:25:47 AM
    Author     : Sandeep
--%>
<%@page import="com.google.gson.Gson,java.text.SimpleDateFormat,java.util.Iterator,java.util.*,org.apache.jasper.tagplugins.jstl.core.Set,java.util.LinkedHashMap,com.progen.reportview.bd.PbReportViewerBD"%>
<%@page import="prg.db.ContainerConstants,prg.db.PbReturnObject,com.progen.reportdesigner.db.ReportTemplateDAO,utils.db.ProgenParam,com.progen.action.UserStatusHelper,com.progen.report.PbReportCollection,prg.util.screenDimensions,java.util.ArrayList"%>
<%@page import="com.progen.db.ProgenDataSet,prg.db.Container,java.util.HashMap,com.google.gson.reflect.TypeToken,com.progen.reportview.db.PbReportViewerDAO,java.lang.reflect.Type,prg.db.PbDb,com.progen.report.display.DisplayParameters"%>
...
<%
        ...
        cydate=dateFormat.format(containerNew.cystdate);
            }
...
<%
            ...
            if (map1 != null && (!map1.isEmpty())) {
                ...
                // collect.reportParameters.get(a1[0]).get(8);
...
<!--        <script src="<%=request.getContextPath()%>/javascript/lib/jquery/js/jquery-1.4.2.min.js" type="text/javascript"></script>-->
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/treeview/zebra_datepicker.js"></script>
            ...
            <%
             if (a11 != null) {
                 ...
                 filterMapNew["<%=a11[j]%>"]=new Array();
                     //                        alert($("#CBOARP111613").val());
                 //filterMapNew["<%=a11[j]%>"]=JSON.parse($("#CBOARP<%=a11[j]%>").val())
            <%}
                                 }%>
...
//expandDiv2('<%=i%>')
    ...
    globalFilter1('<%=onlyname.get(i)%>');
            <%}%>
    //   $('#perioddate1').val($('#perioddate').val());
      //alert("hello"+$('#perioddate').val());
    //     var k=<//%=ParamSectionDisplay%>;
    //     alert(k);
    $("#kpisDialog").dialog({
        autoOpen: false,
        height: 360,
            ...
            <%}%>
                                        ...
                                        function displayTimeDB(measures,timeperiods,isTimeDbrd){
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data){
                                                    document.forms.submitReportForm.action = "reportViewer.do?reportBy=viewReport&action=measChange&REPORTID="+REPORTID+"&isKPIDashboard=true";
...
//                                            alert(excludeIconId)
                                        ...
                                        function saveKPIDashboard(){
                                            ...
                                            var repName=$("#Dashboardname").value;
...
//                                            alert(repName+"::"+repId)
                                        ...
                                        function submitformkpi(){
                                            setNewDate();
                                            setMultiFilter()
                                            //alert("filterMapNew"+JSON.stringify(filterMapNew))
                                            document.getElementById('loading').style.display='';
                                            document.forms.submitReportForm.action = "reportViewer.do?reportBy=viewReport&action=paramChange&REPORTID="+<%=ReportId%>+"&isKPIDashboard=true&globalkpifilter="+globalval;
                                            //    alert(document.forms.submitReportForm.action.val())
                                            document.forms.submitReportForm.submit();
                                        }
                                         ...
                                         {
                                             //alert(globalval)
                                            //alert($('#perioddate1').val())
                                            //alert($('#datepicker').val())
                                            //alert($('#perioddate').val())
                                            //$('#datetext').val('topdate');
                                            //$('#datepicker').val($('#perioddate1').val());
                                            //$('#perioddate').val($('#perioddate1').val());
                                            //alert($('#datepicker').val())
//                                            alert($('#newdate').val());
                                ...
                                type: 'GET',
                                    ...
                                    cache: false,
                                    timeout: 30000,
                                 url:"<%=request.getContextPath()%>/reportTemplateAction.do?templateParam=ParseNewdate&newdate="+date,
                               success:function(data)
                                 {
//                                                     alert(data);
                                                     $('#perioddate').val(data);
...
//                                                alert(JSON.stringify(filterMapNew[keys[i]]))
                                                ...
                                                {
                                                    //                 alert(JSON.parse(filterMapNew[keys[i]]))
                                                    //                 alert(JSON.parse(filterMapNew))
                                                    var temp=[];
                                                    temp.push("All");
//                                                    alert(JSON.stringify(temp))
                                        ...
                                        //
                                        //            }
                                        function tabparamListDisp2(globalval1){
                                            ...
                                            if(paramValq=='show_param'){
                                                ...
                                                $("#tabParameters1").css('height', divHeight-100);
                                                $("#tabParameters1").css('width', widt-500);
                                                var h2=$("#headerTableData").height();
                                                //h2=h2/2;
                                                var heit=(divHeight-100-h2);

                                                // $(".dynamicClass").css('height', (((9/10)*(divHeight))-(viewbys*12)));
                                                $(".dynamicClass").css('height', heit);
                                                $(".dynamicClass").css('width', widt-500);
                                        ...
                                        function openNewReportDtlsTimeDB(ctxPath){
                                        ...
                                        function dispChangeTableColumnsTimeDB(ctxPath,bizRoles,reportId){
                                            $.ajax({
                                                url:ctxPath+'/reportViewer.do?reportBy=loadDialogs&loadDialogs=true&currentReportId='+reportId+'&currentBizRoles='+bizRoles,
                                                success:function(data) {
                                                    $("#tableColsDialog").dialog('open');
                                        ...
                                        function reportDrillAssignmentkpi1(ctxtPath,reportId,multireport){
        ...
        position: 'justify',
        modal: true,
        title: "Assign Report Drill: " //+ chartDetails["Name"]
    });
             ...
             title:"Save dashboard"
              ...
              $("#saveNewdashboard").dialog('open')
                                        ...
                                        function applyGlobalFilterinOneview(id,nameArr,chekid){
                                            //filterMapNew["mohit"]=new Array();
                                            //filterMapNew["mohit"].push("1");
                                            //filterMapNew["mohit"].push("2");
                                            //alert($("#CBOARP111613").val());
                                            //alert(JSON.stringify(filterMapNew))
                                            //   alert($("#"+chekid).val().split("_")[0])
                                            var id=$("#"+chekid).val().split("_")[2]
                                            //   alert(id)
                                            // alert($("#CBOARP"+id).val());
                                            //   alert(JSON.parse($("#CBOARP"+id).val()));
                                            //   alert($("#kpi"+id).val())
                                            //   $("#loading").show();
                                            var filterValues=[];submit
                                            ...
                                            if(document.getElementById(chekid).checked){
                                                ...
                                                filterMapNew[$("#"+chekid).val().split("_")[2]].push($("#"+chekid).val().split("_")[0]);
                                            }
                                            else{
                                                filterMapNew[$("#"+chekid).val().split("_")[2]]=  filterMapNew[$("#"+chekid).val().split("_")[2]].remove($("#"+chekid).val().split("_")[0]);
                                                //        filterValues.splice(index, 1);
                                            }
                                            //    alert("filterMapNew"+JSON.stringify(filterMapNew[$("#"+chekid).val().split("_")[2]]))
                                            $("#CBOARP"+id).val(JSON.stringify(filterMapNew[$("#"+chekid).val().split("_")[2]]))
                                            //    parent.$("#filters1").val(JSON.stringify(filterMap));
                                            // alert( parent.$("#filters1").val())
                                        }

                                        function tagreport(reportid){
                                                // alert(reportid)
                                            var ctxPath='<%=request.getContextPath()%>'
                                            $("#topBottomDispDiv").hide();
                                            $( "#remainingRegions" ).hide()
                                            $( "#tagreport" ).show();
                                            var title = document.getElementById(reportid).getAttribute("title");
                                            // alert(title)
                                            //                alert(selectedSlice)
                                            //                if(selectedSlice!=''){
                                            ...
                                            //                                <span  style='color:#336699'><h1 align='center' style='margin-top:50px;color:white;font:18px Arial, Helvetica, sans-serif' onclick='' title='//"+keys[i]+"'> "+keys[i]+" </h1></span>\n\
                                            //                                </div></tr>\n\
                                            //                                    <tr><div style='height:50px;border-top:1px dotted white' title='//"+keys[i]+"'>\n\
                                            //                                    <h4 align='center' style='color:white;font:11px Arial, Helvetica, sans-serif'> //"+keys[i]+"</h4>\n\
                                            //                     //       </div></tr></td></table></div>\n\
                                            //                            </div> //";
                                            //                                if(i>12 && i<=24){
                                            //                                    alert("111")
                                            ...
                                            //                                <table><tr><td><div style='height:60px' >\n\
                                            //                               <span href='#' style='color:#336699' ><h1 align='center' style='margin-top:50px;color:white;font:18px Arial, Helvetica, sans-serif' onclick='' title='//"+keys[i]+"'> "+keys[i]+" </h1></span>\n\
                                            //                                </div></td></tr>\n\
                                            //                                    <tr><div style='height:50px;border-top:1px dotted white' title='//"+keys[i]+"'>\n\
                                            //                                    <h4 align='center' style='color:white;font:11px Arial, Helvetica, sans-serif'> //"+keys[i]+"</h4>\n\
                                            //                            </div></tr></table></div>\n\
                                            ...
                                            $.ajax({
                                                ...
                                                async: false,
                                                    cache:false,
                                                timeout: 30000,
                                                url:ctxPath+'/reportViewer.do?reportBy=getTagsBlocks&userId='+<%=userid%>+'&tagId='+reportid,
                                                success:function(data) {
                                                    ...
                                                    if(tagShortDesc.length==0){
                                                        ...
                                                        for(var i=0;i<tagShortDesc.length;i++){
                                                            ...
                                                            if(tagType[i]=="R"){
                                                                div+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i+1)+"' onclick='ToglFiltr("+reportId[i]+",\""+tagShortDesc[i]+"\")' style=' margin: 2%;;margin-top: 2%;width: 20%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                            <table style='border:1px solid gray' ><tr><td bgcolor='#f0f5f8'><div style='height:70px' >";

                                                            } else if(tagType[i]=='O'){
                                                                div+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i+1)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 2%;margin-top: 2%;width: 20%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                            <table style='border:1px solid gray'><tr><td bgcolor='#f0f5f8'><div style='height:70px' >";
                                                            }else if(tagType[i]=='T'){
                                                                div+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i+1)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 2%;margin-top: 2%;width: 20%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                            <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >";
                                                            } else {
                                                                div+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i+1)+"'  style=' margin: 2%;margin-top: 2%;width: 20%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                            <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >";
                                                            }
                                                            div+="<a href='#' style='color:#336699' onclick=''><h1 align='center' style='margin-top:20px;color:black;font:18px Arial, Helvetica, sans-serif' onclick='' title='"+tagShortDesc[i]+"'> "+tagShortDesc[i]+" </h1></a>";
                                                            div+="</div></td></tr></div> ";
                                                            ...
                                                            //                                        var div1="";
                                                            //                                        if(tagType[i]=="R"){
                                                            //                                       div1+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-11)+"' onclick='ToglFiltr("+reportId[i]+",\""+tagShortDesc[i]+"\")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                              <table style='border:1px solid gray'><tr><td><div style='height:70px' >//";
                                                            //
                                                            //                                    } else if(tagType[i]=='O'){
                                                            //                                      div1+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-11)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                              <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >//";
                                                            //                                    } else if(tagType[i]=='T'){
                                                            //                                      div1+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-11)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                               <table style='border:1px solid gray'><tr><td><div style='height:70px' >//";
                                                            //                                    } else {
                                                            //                                       div1+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-11)+"'  style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                               <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >//";
                                                            //                                    }
                                                            //                                     div1+="<a href='#' style='color:#336699' onclick=''><h1 align='center' style='margin-top:20px;color:black;font:18px Arial, Helvetica, sans-serif' onclick='' title='"+tagShortDesc[i]+"'> "+tagShortDesc[i]+" </h1></a>";
                                                            //
                                                            //                                        div1+="</div></td></tr></div> ";
                                                            //
                                                            //
                                                            ...
                                                            //                                        var div2="";
                                                            //                                       if(tagType[i]=="R"){
                                                            //                                       div2+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-23)+"' onclick='ToglFiltr("+reportId[i]+",\""+tagShortDesc[i]+"\")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                               <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >//";
                                                            //
                                                            //                                    } else if(tagType[i]=='O'){
                                                            //                                      div2+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-23)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                               <table style='border:1px solid gray'><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >//";
                                                            //                                    }  else if(tagType[i]=='T'){
                                                            //                                      div2+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-23)+"' onclick='openOneView("+reportId[i]+")' style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                                <table ><tr><td><div style='height:70px' >//";
                                                            //                                    }else {
                                                            //                                       div2+="<div id='tile_"+tagType[i]+"_"+i+"' class='small"+(i-23)+"'  style=' margin: 1%;margin-top: 4%;width: 22%;height: 90px; cursor: pointer;display: inline; float: left;'>\n\
                                                            //                                <table><tr><td  bgcolor='#f0f5f8'><div style='height:70px' >//";
                                                            //                                    }
                                                            //                                     div2+="<a href='#' style='color:#336699' onclick=''><h1 align='center' style='margin-top:20px;color:black;font:18px Arial, Helvetica, sans-serif' onclick='' title='"+tagShortDesc[i]+"'> "+tagShortDesc[i]+" </h1></a>";
                                                            //
                                                            //                                       div2+="</div></td></tr></div> ";
                                                            //
                                                            //
...
//                                                alert(document.getElementById(id).checked)
                                                if(id=="0"){
                                                    for(var i=0; i< 7; i++){
//                         alert(document.getElementById(dependentTimePeriodsdisplay[i]).checked)
//alert(dependentTimePeriodsdisplay[i])
                                                        document.getElementById(dependentTimePeriodsdisplay[i]).checked=true;
//                                                        $("#"+dependentTimePeriodsdisplay[i]).prop('checked', true);
                                                         // $("#"+ dependentTimePeriodsdisplay[i]).prop('checked', true);
                                                    }
                                                }else if(id=="1"){
                                                    for(var i=7; i< 14; i++){
...
//                                               alert(document.getElementById(id).checked)
        ...
        <style>
            ...
            { display: block; position: absolute; width: 16px; height: 16px; background: url('images/newdatecalendar.png') no-repeat left top; text-indent: -9000px; border: none; cursor: pointer; padding: 0; line-height: 0; vertical-align: top }
...
<!--         <div width="99%" height="100%" valign="top" >-->
            <form name="submitReportForm" id="submitReportForm" method="POST" action="">
                    ...
                    <div id="fixedtop1" >
                        ...
                        <div id="center250b">
                            ...
                            <div class="form clearFix" style="display:none">
                                <span class="wr100">
                                    <table align="center" id="roundtrip" style="display:none">
                ...
                <!--                                    <tr style=""><td>
                        <select id="new11" multiple style="">
                ...
                <div id="dateregionDiv" style="display:none;width:100%">
                    <div id="fixedtop1" >
                        <div id="center250a">
                            <div class="form clearFix" style="position: absolute;left: 200px;top:0px;">

                                <table align="center" id="roundtrip" style="display:block;">
                                    <!--
                                <tr width="100%">
                                 <td align="right">
                                    <% if (sytm.equalsIgnoreCase("No")) {
                     if (fromDesignerkpi != null && fromDesignerkpi.equalsIgnoreCase("true")) {%><span class="top w100 mrtop" id="pfield1"><%=(container.fullName0)%></span>
                                    <%} else {%>
             ...
             <script type="text/javascript">
                    ...
                    setyear1="Mon,01,Jan,".concat(setyear1)
                                 $('#perioddate').val(setyear1);
                                    ...
                                    <tr>
                                        <!--                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>-->
                                        <td><input  type="text" readonly="true"  value="Till Date"  style="background-color: #B4D9EE; width:60px;height:16px padding: 0.3em; border: 1px solid #CCC; " /></td>
                                        <!--                    <td width="100"><input  type="text" readonly="true" class="navtitle-hover" value="Till Date"  style="height: 20px; width: 50px" /></td>
                                         <td  width="50px" height="50px" style="background-color: #B4D9EE; padding: 0.6em; border: 1px solid #CCC; " id="Fn">Till Date</td>-->
                                        <!--
                                                     <td></td><td></td> <td><input class="ui-textfield"   type="text" id="perioddate1" name="perioddate1" onclick="changedate()" style="width: 80px;" /><td>
                                                 <td> <input  type="hidden" id="datetext" name="datetext" value=""/></td>-->

<!--                                        <td align="right">

                                            <span class="top w100 mrtop22" id="pfield1"><%=(container.fullName0)%></span>
                                            <span class="date">
                                                <small Style="font-weight: bold" id="pfield2"><%=container.dated%></small></span>
                                            <span class="bottom w100" id="pfield3"><%=container.day0%></span></td>-->
                                    <!--                    <td> <a ><img alt="More" src="<%=request.getContextPath()%>/images/calendar_18x16.gif" style="float: right"/></a> </td>-->
                                        <td> <input height="100px" width="100px" type="hidden" class="" id="perioddate" name="perioddate" /><td>
                                        <td> <input  type="hidden" id="datetext" name="datetext" value=""/></td>
                                                   <td> <input  type="text" id="newdate" name="newdate" onclick="changedate(this.id)" style="width:100px;color: black;" value="<%=(container.dated+""+"-"+(((container.fullName0)+"").replaceAll("'","-")))%>"/><td>
                                        </td>
                                        <%if (isKPIDashboard == "true") {%>
                                        <td id="saveTabId" ><a style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;font-size: 9pt;" class="ui-icon ui-icon-disk" title="Global Save" href="javascript:overWriteReport1('<%=request.getContextPath()%>','overWrite')"></a></td>
                                        <%} else {%>
                                        <td id="saveTabId" ><a href="javascript:void(0)" style="text-decoration: none;font-family: Calibri, Calibri, Calibri, sans-serif;font-size: 9pt;" class="ui-icon ui-icon-disk" title="Global Save" onclick="saveKPIDashboard()"></a></td>
                                        <%}%>
                                        <td> <a onclick="openImgDiv()" href="<%=resetpath%>"> Reset&nbsp; </a></td><td></td><td></td>
                              <!--            <td id="dateToggle"><a href="javascript:void(0)" class="ui-icon ui-icon-transferthick-e-w" title="Toggle" onclick="datetogglkpi('<%=userType%>','<%=isPowerAnalyserEnableforUser%>')"></a></td>-->
                                        <td width="35"><input  type="button" class="navtitle-hover" value=" Go "  style="height: 20px; width: 25px" onclick="submitformkpi()"/></td>
                                    </tr>
                                   <% if (isKPIDashboard == "true") {%>
                                    <tr>
                                        <td colspan="12" style="text-align: center"><input readonly="true" type="text" style="width:75%;color: black;" value="<%=(cydate)%> TO <%=(container.dated+""+"-"+(((container.fullName0)+"").replaceAll("'","-")))%>" ></td>
                ...
                <table style="min-width:100%;font-family: Calibri, Calibri, Calibri, sans-serif;font-size:14pt;color: darkblue" max-height="auto" max-width="auto" >
                    ...
                    <tr><td>
                                        ...
                                        <%
                                                    HashMap map = collect.reportParameters;
                                                    ArrayList al1 = null;
                                                    List al2 = null;
                                                    //  for(int i=0; i <map.size() ; i++){ ;
                                                    String[] a1 = (String[]) (map.keySet()).toArray(new String[map.size()]);
                                                    // collect.reportParameters.get(a1[0]).get(8);
                                                    ReportTemplateDAO rtd = new ReportTemplateDAO();
                                                    HashMap<String, ArrayList> AllFilterValues = rtd.GetAllFilterValues(a1);
                                                    if (map.size() > 2) {
                                                        for (int j = 0; j < map.size(); j++) {
                                                            al1 = (ArrayList) map.get(a1[j]);
                                                            //al1 = al1.replace(" ", "1q1");
                                                            al2 = (List) al1.get(8);
                                        %>
                                                ...
                                                <!--                            <tr>
                                                                         <td style= "background-color: #B4D9EE; border: 2px solid #CCC;"> <%=al1.get(1)%></td></tr>-->
                                                <tr style=""><td><select id=<%=al1.get(1).toString().replaceAll(" ", "1q1")%> multiple style="">

                                                            <%

                                                                                          boolean flag = false;
                                                                                          for (int k = 0; k < AllFilterValues.get(a1[j]).size(); k++) {
                                                                                              String value = AllFilterValues.get(a1[j]).get(k) + "_" + k + "_" + a1[j];
                                                                                              for (int l = 0; l < al2.size(); l++) {
                                                                                                  if (AllFilterValues.get(a1[j]).get(k).toString().equalsIgnoreCase(al2.get(l).toString())) {
                                                               value = value + "_selecttrue";%>
                                                            <script type="text/javascript">
                                                                filterMapNew["<%=a1[j]%>"].push("<%=al2.get(l).toString()%>");

                                                                <% }
                                                                                     }

                                                                %>
                                                        //    alert((JSON.stringify(filterMapNew["<%=a1[j]%>"])))
                                                            </script>

                                                            <option  value="<%=value%>"><%=AllFilterValues.get(a1[j]).get(k)%></option>

                                                            <%}
                                                       if (flag == false) {%>
                                                            <script> var temp=[];
                                                               temp.push("All");
                                                                $("#CBOARP<%=a1[j]%>").val(JSON.stringify(temp))
                                                            </script>
                                                            <%}%>
                                            ...
                                            <input id='gottabId1' class='navtitle-hover' type='button'  value='Go' onclick='submitformkpi()' style='width:25px; background:white; border-radius:10px ;margin-left: 10px'>
                                        </td>
                                                                           <%  } else if(map.size() > 0 && map.size() <= 2){
                                                                                 for (int j = 0; j < map.size(); j++) {
                                                                                     al1 = (ArrayList) map.get(a1[j]);
                                                                                     al2 = (List) al1.get(8);
                                                        %>
                                                ...
                                                <!--                            <tr>
                                                                         <td style= "background-color: #B4D9EE; border: 2px solid #CCC;"> <%=al1.get(1)%></td></tr>-->
                                                <tr style=""><td><select id=<%=al1.get(1).toString().replaceAll(" ", "1q1")%> multiple style="">
                                                            <!--                        <tr><td style=' border: 2px solid #CCC;'><select name="bbn" id="Status" style="width:80px;" >-->
                                                            <%  boolean flag = false;
                ...
                <table>
                    <tr>
                        ...
                        <td valign="top" style="width:3%;position: relative">
                            ...
                            <!--       <a href="javascript:void(0)" class="ui-icon ui-icon-plusthick" onclick="AddmoreMeasuresforTimeDB()"></a>-->
                        </td>
                        <%} else {%>
                        <td width="97%"></td>
...
<!--                        <td> <a onclick="paramListDisp()"  title="Click Here For More Options"><img alt="More" src="<%=request.getContextPath()%>/images/moreIcon.png" style="float: right"/></a> </td>-->
                ...
                <input type="hidden" name="Dashboardname" value="<%=Dashboardname%>" id="Dashboardname">
                                        ...
                                        <tbody valign="top">
                                            ...
                                            <tr id="previewTable" style="height:100%;">
                                                <td  style="height:100%;" valign="top" >
                                                    ...
                                                    <div id=KpiDashboardDiv class='ui-tabs ui-widget ui-widget-content ui-corner-all' style='border-bottom: medium hidden LightGrey ; border-left: medium hidden LightGrey ; border-right: medium hidden LightGrey ; border-color: LightGrey ; width: 100%; height: 600px; margin-left: 10px; margin-right: 10px;'>
                                                        <%if (isKPIDashboard == "true") {%>
                                                        <%=result%>
                                                        <%}%>
                                                    </div>
...
<!--added by latha-->
        <div id="timePeriodDialog" style="display:none;height: auto;" title="Select Period">
<!--           <table style="width:100%" class="collapseDiv1" style="display: block;">-->
                 <%int count1 = 0;
                     for (int i = 0; i < listOfTimePeriods.length; i++) {
                        // String nmae="expandDiv11"+listOfTimePeriods[i]+" expandDiv44 ";
                         String nmae="expandDiv2"+i+" expandDiv44";
                       %>
                  <div  class="<%=nmae%>"  name="expand" width="13%" onclick="expandDiv2('<%=i%>')" style="border-bottom: 1px solid lightgrey;height:22px;background-color:#F1F1F1">
                  <div class=""  style="paddind-top:2px;padding-left:10%">
                      <label class="headl" style="font-size: 11px;color:rgb(79,76,89);">
                          <input class="ckbox" id="<%=i%>" onclick="checkall(this.id)" type="checkbox">
                    <span class="custom-checkbox" style="white-space:nowrap" ><%=listOfTimePeriods[i]%></span></label></div></div>
                     <div id="vsdiv14<%=i%>" class="collapseDiv1" style="display: block;">
                      <table width="100%" class="collapseDiv1" style="display: block;"><tbody>
                                       <%  if (i == 0) {
                                         for (int j = 0; j < 7; j++) {%>
               <tr><td><label style="font-color:#343434;font-size: .7em;">
                                 <span class="custom-checkbox"><input class="ckbox" id="<%=dependentTimePeriodsdisplay[count1]%>"  type="checkbox">
                     <span  class="box"><%=dependentTimePeriodsdisplay[count1]%></span></span></label></td></tr>
                        <%   count1++;
                                                }
                                            }
                                            if (i == 1) {
                                                for (int j = count1; j < 14; j++) {%>
                <tr><td><label style="font-color:#343434;font-size: .7em;">
                                 <span class="custom-checkbox"><input class="ckbox" id="<%=dependentTimePeriodsdisplay[count1]%>"   type="checkbox">
                                     <span class="box"><%=dependentTimePeriodsdisplay[count1]%></span></span></label></td></tr>
                        <%count1++;
...
<% }%>
<table> </tbody>   <tr><td></td><td align="left"><input type="button" style="height: auto;margin-left: 80px;margin-top: 20px;" value="Done" onclick="checkSelectedPeriods()"></td></tr></table>
                  </div>
<!--ended by latha-->

<!--                <div id="mydialog" style="display:none" title="Select Period">

                </div>
  -->

        <div id="allParametersTab" style="display:none;width:40%;height:140%;background-color:white; direction: ltr; float: right; position:absolute;text-align:left;border:1px solid #000000;left:0px;top:122px;z-index: 1000;overflow: auto;border-color: LightGrey;">
            <table>
                <tr><td  style="padding-top:6px"></td></tr>

                <tr><td style="padding-left:20px"><a href="javascript:void(0)"class='ui-icon ui-icon-star' title="Favourite Links" onclick="remainingRegions()"></a></td>

                    <!--                    <padding-right:10px"><a href="javascript:void(0)"class='ui-icon ui-icon-video' title="SnapShots" onclick="getsnapShots()"></a></td>-->

                    <td><td style="padding-left:10px"><a href="javascript:void(0)"class='ui-icon ui-icon-mail-open' title="Tag Name" onclick="getdisplayTopBottom()"></a></td><!--

                    <td><d style="paddingright:10px"><a href="javascript:void(0)"class='ui-icon ui-icon-lightbulb' title="Information about Report" onclick="getdisplayBusRoles()"></a></td>

                    <td><td style="padding-right:10px"><a href="javascript:void(0)"class='ui-icon ui-icon-mail-open' title="Tag Name" onclick="getdisplayTopBottom()"></a></td><!--

                    -->                     <td><td align="right" style="padding-left:460px"><a href="javascript:void(0)"class='ui-icon ui-icon-triangle-1-w' title="Hide Favourite Links" onclick="closeAllparamsTab()"></a></td>
                </tr>
            </table><hr style="color:LightGrey;">
            <div id="remainingRegions" style="width:80%;display:none;">
                <table width="100%">
                    <tr><td ><u><span style="font-size:12px;padding-left:30px;font-family: Calibri, Calibri, Calibri, sans-serif;font-weight:bold;">Favourite Links</span></u></td></tr>
                    <tr style="width:99%;height:100%;">
                        <td style="width:99%;height:100%;">
                            <% ReportTemplateDAO rDao = new ReportTemplateDAO();%>
                            <%=rDao.getFavLiksRegionkpi(session, request.getContextPath())%>
                        </td>
                    </tr>
            ...
            <div id="topBottomDispDiv" style="width:100%;display:none;">
                ...
                <table id="topBot" style="padding-left:50px"; class="ui-corner-all" style="width:100%;height:100%">
                       <tr><td ><u><span style="font-size:18px;padding-left:40px;font-family: Calibri, Calibri, Calibri, sans-serif;font-weight:light;">Tags Name </span></u></td></tr>
                    <%= rDao.getDataCall(userid)%>


                </table>
            </div>
            <div id="tagreport" style="width:100%;display:none;">
