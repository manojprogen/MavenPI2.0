...
function addDate(date)
{
    ...
    if(freq=='3') //Weekly Frequency. If weekly is selected, data option should be disabled. Else Data selection row should be shown.
    {
