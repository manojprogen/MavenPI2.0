...
//                alert('in dispusers userid is : '+userId)
                ...
                if(userFoldersIds.length!=0){
                    ...
                    //document.myFormUser.action = "saveUserFolderAssignment.do?grpId="+grpIds+"&userId="+userId+"&userFolderIds="+usersFolders;
                    //  alert(document.myFormUser.action)
                    //  document.myFormUser.submit();
                    //  alert('saveUserFolderAssignment.do?grpId='+grpIds+'&userId='+userId+'&userFolderIds='+usersFolders)
//                    alert('grpIds are : '+grpIds)
//                    alert('usersFolders are : '+usersFolders)
                    $.ajax({
        ...
        <form name="myFormUser" action="" method="post">
            ...
            <table align="center" border="1" width="100%" style="height:200px" valign="top">
                ...
                for (int i = 0; i < pbro.getRowCount(); i++) {%>
                                ...
                                <%}
    } else if (pbroAvailable.getRowCount() > 0) {
            ...
            %>
                ...
                for (int i = 0; i < pbroAvailable.getRowCount(); i++) {%>
                                ...
                                <td valign="top" class="myDragTabs" class="ui-state-default3" style="width:200px" id="u~<%=pbroAvailable.getFieldValueString(i, 0)%>,<%=pbroAvailable.getFieldValueString(i, 1)%>"><%=pbroAvailable.getFieldValueString(i, 2)%></td></tr>
                                <%}
                                }
