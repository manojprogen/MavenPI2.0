 ...
 * USA.  
 *
 * [Java is a trademark or registered trademark of Sun Micro//Systems, Inc. 
 * in the United States and other countries.]
 *
 * ---------------------------------
 * PrgStandardCategoryURLGenerator.java
 * ---------------------------------
 ...
 *                   Cleland Early;
 *
 * $Id: PrgStandardCategoryURLGenerator.java,v 1.6.2.2 2007/02/02 15:51:05 mungady Exp $
 *
 * Changes:
 * --------
 ...
 */
public class PrgStandardCategoryURLGenerator implements org.jfree.chart.urls.CategoryURLGenerator,
     ...
     */
    public PrgStandardCategoryURLGenerator() {
        super();
    }
     ...
     */
    public PrgStandardCategoryURLGenerator(String prefix) {
        if (prefix == null) {
    ...
    public PrgStandardCategoryURLGenerator(String prefix, String suffix) {
        if (prefix == null) {
            throw new IllegalArgumentException("Null 'prefix' argument.");
        }
        if (suffix == null) {
    ...
    public PrgStandardCategoryURLGenerator(String prefix, String suffix, String url) {
        if (prefix == null) {
            throw new IllegalArgumentException("Null 'prefix' argument.");
        }
        if (suffix == null) {
     ...
     * <code>null</code> not permitted).
     *
     * public PrgStandardCategoryURLGenerator(String prefix, String
     * seriesParameterName, String categoryParameterName) {
     *
     * if (prefix == null) { throw new IllegalArgumentException("Null 'prefix'
     * argument."); } if (seriesParameterName == null) { throw new
     * IllegalArgumentException( "Null 'seriesParameterName' argument." ); } if
     * (categoryParameterName == null) { throw new IllegalArgumentException(
     * "Null 'categoryParameterName' argument." ); } this.prefix = prefix;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PrgStandardCategoryURLGenerator)) {
            return false;
        }
        PrgStandardCategoryURLGenerator that = (PrgStandardCategoryURLGenerator) obj;
