 ...
 * PrgStandardPieURLGenerator extention to support javascript url
 */
 ...
 */
public class ProgenStandardPieURLGenerator extends org.jfree.chart.urls.StandardPieURLGenerator {
     ...
     * Default constructor.
     */
    public ProgenStandardPieURLGenerator() {
        this("index.html");
    }
     ...
     */
    public ProgenStandardPieURLGenerator(String prefix) {
    ...
    public ProgenStandardPieURLGenerator(String prefix, String suffix, String url, int i) {
        if (prefix == null) {
    ...
    public String generateURL(PieDataset dataset, Comparable key,
        ...
        if (this.url == null || this.url.equals("")) {
            ...
            url += "'" + this.url + key.toString() + "'";
        }
        url += this.suffix;
        /*
         * if (url.indexOf("?") > -1) { url += "&amp;" +
         * this.categoryParameterName + "=" +
         * URLUtilities.encode(key.toString(), "UTF-8"); } else { url += "?" +
         * this.categoryParameterName + "=" +
         * URLUtilities.encode(key.toString(), "UTF-8"); } if
         * (this.indexParameterName != null) { url += "&amp;" +
         * this.indexParameterName + "=" + String.valueOf(pieIndex);
        }
         */
        return url;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProgenStandardPieURLGenerator)) {
            return false;
        }
        ProgenStandardPieURLGenerator that = (ProgenStandardPieURLGenerator) obj;
