 ...
 */
public class DataSnapshotResourceBundleSqlServer extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        {"getDataSnapShotId", "select IDENT_CURRENT('PRG_AR_DATA_SNAPSHOTS')"},
        {"insertDataSnapShots", "insert into PRG_AR_DATA_SNAPSHOTS(DATA_SNAPSHOT_NAME,REPORT_ID,REFRESH_INTERVAL,CREATED_BY,UPDATED_BY,DATA_HTML_VIEW,CREATE_DATE,UPDATED_DATE,LAST_REFRESHED,HTML_REPORT_TYPE) values('&',&,&,&,&,'&',getdate(),getdate(),getdate(),'&')"},
        ...
        {"updateHtmlView", "update PRG_AR_DATA_SNAPSHOTS set DATA_HTML_VIEW=?,LAST_REFRESHED=getdate() WHERE DATA_SNAPSHOT_ID=?"},
        {"getSysdate", "select getdate() SYSDATE"},
        ...
        {"updateHtmlView1", "update PRG_AR_DATA_SNAPSHOTS set DATA_HTML_VIEW='na',LAST_REFRESHED=getdate() WHERE DATA_SNAPSHOT_ID=&"},
        {"getHeaderTitle", "select SETUP_CHAR_VALUE from PRG_GBL_SETUP_VALUES where SETUP_KEY='COMPANY_NAME'"},
        ...
        {"getHeadlineId", "select IDENT_CURRENT('PRG_AR_HEADLINES')"},
