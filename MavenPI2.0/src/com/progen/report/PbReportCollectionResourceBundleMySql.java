 ...
 * @author db2admin
 */
public class PbReportCollectionResourceBundleMySql extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        ...
        , {"getParameterTimeInfo", "select m.rep_time_id , m.time_level , m.time_type , d.column_type, d.column_name, d.sequence, d.form_sequence ,date_format(d.default_date,'%m/%d%/%Y'),d.default_value"
