 ...
 * @author Saurabh
 */
public class CustomMeasureResourceBundleMySql extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        ...
        //added by Nazneen
        , {"getRefElId", "SELECT REF_ELEMENT_ID FROM PRG_USER_SUB_FOLDER_ELEMENTS WHERE ELEMENT_ID=&"} //            ,{"getUpdateForPrior","update PRG_USER_ALL_INFO_DETAILS set actual_col_formula = '&', reffered_elements = '&' where ref_element_id=& and ref_element_type =2"}
