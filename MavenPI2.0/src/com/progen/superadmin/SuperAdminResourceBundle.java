 ...
 * @author progen
 */
public class SuperAdminResourceBundle extends ListResourceBundle {

    protected Object[][] getContents() {
        return contents;
    }
    static final Object contents[][] = {
        {"insertModules", "INSERT INTO PRG_USER_MODULE_ASSIGNMENTS(MOD_ASSIGN_ID,USER_ID,MODULE_ID,MODULE_CODE,USER_TYPE_ID) VALUES(&,&,&,'&',&)"},
        ...
        {"nextQry", "SELECT PRG_USER_MODULE_SEQ.NEXTVAL from dual"},
        //        {"getModulesQry","SELECT MOD_ASSIGN_ID,MODULE_CODE from PRG_USER_MODULE_ASSIGNMENTS WHERE USER_ID=&"},
        ...
        {"getComponentsQry", "SELECT COMPONENT_CODE,PARENT_COMP_CODE FROM PRG_USER_MOD_COMP_ASSIGNMENTS WHERE MOD_ASSIGN_ID=& "},
        //        {"countQry","SELECT COUNT(*) COUNT FROM PRG_USER_MODULE_ASSIGNMENTS WHERE MODULE_CODE='&'"},
        {"countQry", "SELECT COUNT(*) COUNT FROM PRG_USER_TYPE_PRIVILEGE WHERE MODULE_CODE='&'"},
