...
public class PbUserLayerEditResourceBundleSqlServer extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        ...
        //                 "a.COLUMN_DISP_NAME as USER_COL_DESC,a.COLUMN_TYPE,& AS SUB_FOLDER_TAB_ID,a.DEFAULT_AGGREGATION, 1 REF_ELEMENT_TYPE, isnull(a.COLUMN_DISPLAY_DESC,a.COLUMN_DISP_NAME ) COLUMN_DISPLAY_DESC FROM PRG_GRP_BUSS_TABLE_DETAILS a " +
        ...
        , {"getElementsInfo", " SELECT & AS SUB_FOLDER_ID,a.BUSS_TABLE_ID,a.BUSS_COLUMN_ID,a.COLUMN_NAME as BUSS_COL_NAME,a.COLUMN_DISP_NAME as USER_COL_NAME,"
            + "a.COLUMN_DISPLAY_DESC as USER_COL_DESC,a.COLUMN_TYPE ,& AS SUB_FOLDER_TAB_ID,a.DEFAULT_AGGREGATION, 1 REF_ELEMENT_TYPE, isnull(a.COLUMN_DISPLAY_DESC,a.COLUMN_DISP_NAME ) COLUMN_DISPLAY_DESC FROM PRG_GRP_BUSS_TABLE_DETAILS a "
            ...
            + "a.column_type,& as SUB_FOLDER_TAB_ID,ident_current('PRG_USER_SUB_FOLDER_ELEMENTS'),1 AS REF_ELEMENT_TYPE,a.default_aggregation,'Y' FROM PRG_GRP_BUSS_TABLE_DETAILS a "
