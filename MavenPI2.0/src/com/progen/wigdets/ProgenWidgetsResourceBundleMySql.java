 ...
 * @author Saurabh
 */
public class ProgenWidgetsResourceBundleMySql extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        ...
        {"getAllReports", "select DISTINCT ifnull(b.PUR_CUST_REPORT_NAME,a.report_name) A1, b.report_id,b.pur_fav_report,b.pur_report_sequence  from prg_ar_report_master a, prg_ar_user_reports b "
            + " WHERE b.user_id=& and a.report_id= b.report_id order by b.pur_report_sequence,(ifnull(b.PUR_CUST_REPORT_NAME,a.report_name)) "},
