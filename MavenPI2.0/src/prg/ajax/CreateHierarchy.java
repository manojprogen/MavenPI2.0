 ...
 * @author Saurabh
 */
public class CreateHierarchy extends HttpServlet {
     ...
     */
    public static Logger logger = Logger.getLogger(CreateHierarchy.class);
...
//            pg=new ProgenConnection();
            ...
            String Query = "select member_id, member_name from prg_qry_dim_member where dim_id=" + dimId;
