 ...
 * @author Saurabh
 */
public class DBTableDeleteColumns extends HttpServlet {
     ...
     */
    public static Logger logger = Logger.getLogger(DBTableDeleteColumns.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////.println.println("--------" + request.getParameterValues("chk2"));
            if (colNames != null) {
                String columnIds = "";
                String tabId = request.getParameter("tabledeleteId");
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////.println.println("tabledeleteId==" + tabId);
