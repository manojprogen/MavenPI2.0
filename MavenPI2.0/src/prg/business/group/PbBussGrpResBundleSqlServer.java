...
public class PbBussGrpResBundleSqlServer extends ListResourceBundle implements Serializable {
    ...
    static final Object contents[][] = {
        ...
        , {"insertBussDetailsRelations", " INSERT INTO PRG_GRP_BUSS_TABLE_RLT_DETAILS (BUSS_RELATIONSHIP_ID,BUSS_RELATIONSHIP_DETAIL_ID,P_BUSS_TABLE_ID,"
            + " P_BUSS_COL_ID1,P_BUSS_COL_ID2,S_BUSS_TABLE_ID,S_BUSS_COL_ID1,S_BUSS_COL_ID2,JOIN_TYPE,JOIN_OPERATOR,ACTUAL_CLAUSE ) "
        ...
        , {"insertBussSrcTableDetails", "insert into PRG_GRP_BUSS_TABLE_SRC_DETAILS (BUSS_SRC_ID,DB_TABLE_ID, BUSS_TABLE_ID,DB_COLUMN_ID,"
            ...
            + "SELECT (IDENT_CURRENT('PRG_GRP_BUSS_TABLE_SRC')),table_id,(IDENT_CURRENT('PRG_GRP_BUSS_TABLE')),column_id, "
            + "table_col_name , "
            + "col_type FROM prg_db_master_table_details WHERE table_id=& and is_active='Y'"} /*
        ...
        , {"addTimeDimBussMater", "INSERT INTO PRG_GRP_BUSS_TABLE( BUSS_TABLE_NAME, BUSS_DESC, BUSS_TYPE, NO_OF_NODES, IS_PURE_QUERY,DB_QUERY,"
            ...
            + "values(ident_current('PRG_GRP_BUSS_TABLE'),'&',&,'&')"}, {"addTimeDimSrcDetails", "INSERT INTO PRG_GRP_BUSS_TABLE_SRC_DETAILS( BUSS_SRC_ID, BUSS_TABLE_ID, "
            + "COLUMN_ALIAS, COLUMN_TYPE) values(&,"
            + "ident_current('PRG_GRP_BUSS_TABLE'),'&','&')"}, {"addTimeDimBussDetails", "INSERT INTO PRG_GRP_BUSS_TABLE_DETAILS(BUSS_TABLE_ID, COLUMN_NAME ,"
            + "BUSS_SRC_TABLE_DTL_ID,COLUMN_TYPE, COLUMN_DISP_NAME)values(ident_current('PRG_GRP_BUSS_TABLE'),"
            + "'&',&,'&','&')"}, {"addTimeDimDimension", "INSERT INTO PRG_GRP_DIMENSIONS(DIM_NAME, DIM_DESC, DIM_ACTIVE,GRP_ID)values('&','&','&',&)"}, {"addTimeDimTables", "INSERT INTO PRG_GRP_DIM_TABLES( DIM_ID, TAB_ID)values(ident_current('PRG_GRP_DIMENSIONS'),&)"}, {"addTimeDimTableDetails", "INSERT INTO PRG_GRP_DIM_TAB_DETAILS(  DIM_TAB_ID, COL_ID, IS_AVAILABLE, IS_PK_KEY )"
            + "values(ident_current('PRG_GRP_DIM_TABLES'),&,'&','&')"}, {"addTimeDimMembers", "INSERT INTO  PRG_GRP_DIM_MEMBER( MEMBER_NAME, DIM_ID, DIM_TAB_ID, USE_DENOM_TABLE, DENOM_TAB_ID, DENOM_QUERY, MEMBER_DESC )"
            + "values('&',ident_current('PRG_GRP_DIMENSIONS'),ident_current('PRG_GRP_DIM_TABLES'),'&',ident_current('PRG_GRP_BUSS_TABLE'),'&','&')"}, {"addTimeDimMemberDetails", "INSERT INTO PRG_GRP_DIM_MEMBER_DETAILS( MEM_ID, COL_ID, COL_TYPE, DEFAULT_VAL) values(&,&,'&','&')"}, {"addTimeDimRlt", "INSERT INTO PRG_GRP_DIM_REL( DIM_ID, DESCRIPTION, IS_DEFAULT, REL_NAME) values(ident_current('PRG_GRP_DIMENSIONS'),'&','&','&') "}, {"addTimeDimRltDetails", "INSERT INTO PRG_GRP_DIM_REL_DETAILS(REL_ID, MEM_ID, REL_LEVEL) select ident_current('PRG_GRP_DIM_REL'),&,& "}, {"addTimeDimInfo", "INSERT INTO PRG_TIME_DIM_INFO(BUSINESS_TABLE_ID, MAIN_FACT_ID, MAIN_FACT_COL_ID, MIN_LEVEL,IS_MAIN,IS_AS_OF_DATE_JOIN,BUSINESS_COL_ID)"
            + " values(ident_current('PRG_GRP_BUSS_TABLE'),&,&,&,'&','&',&)"}, {"addTimeDimInfo1", "INSERT INTO PRG_TIME_DIM_INFO(BUSINESS_TABLE_ID, MAIN_FACT_ID, MAIN_FACT_COL_ID, MIN_LEVEL,IS_MAIN,IS_AS_OF_DATE_JOIN,BUSINESS_COL_ID)"
        ...
        , {"addTimeDimBussRltDetails", "INSERT INTO PRG_TIME_DIM_INFO_RLT_DETAILS(BUSS_RELATIONSHIP_ID, P_BUSS_TABLE_ID, P_BUSS_COL_ID1, S_BUSS_TABLE_ID, S_BUSS_COL_ID1, JOIN_TYPE, JOIN_OPERATOR, ACTUAL_CLAUSE,S_COL1_NAME,S_COL1_FORMAT) "
            + "values(ident_current('PRG_TIME_DIM_INFO'),&,&,ident_current('PRG_GRP_BUSS_TABLE'),&,'&','&','&','&','&')"}, {"addTimeDimBussRltDetails1", "INSERT INTO PRG_TIME_DIM_INFO_RLT_DETAILS(BUSS_RELATIONSHIP_ID, P_BUSS_TABLE_ID, P_BUSS_COL_ID1, S_BUSS_TABLE_ID, S_BUSS_COL_ID1, JOIN_TYPE, JOIN_OPERATOR, ACTUAL_CLAUSE,S_COL1_NAME) "
            + "values(&,&,&,&,&,'&','&','&','&')"}//for time Dimention 2nd time
        ...
        , {"addBucketSrc", "INSERT INTO  PRG_GRP_BUSS_TABLE_SRC( BUSS_TABLE_ID, DB_TABLE_ID, SOURCE_TYPE ,DB_TABLE_NAME,CONNECTION_ID,DB_QUERY) "
            + "values(ident_current('PRG_GRP_BUSS_TABLE'),ident_current('prg_db_master_table'),'&','&',&,'&')"}, {"addBucketsrcDetails", "INSERT INTO PRG_GRP_BUSS_TABLE_SRC_DETAILS( BUSS_SRC_ID, DB_TABLE_ID, BUSS_TABLE_ID, "
            + "COLUMN_ALIAS, COLUMN_TYPE,DB_COLUMN_ID) values(ident_current('PRG_GRP_BUSS_TABLE_SRC'),ident_current('prg_db_master_table'),"
            + "ident_current('PRG_GRP_BUSS_TABLE'),'&','&',&)"}, {"addBucketBussDetails", "INSERT INTO PRG_GRP_BUSS_TABLE_DETAILS( BUSS_TABLE_ID, COLUMN_NAME, DB_TABLE_ID, "
            + "BUSS_SRC_TABLE_DTL_ID,COLUMN_TYPE, BUCKET_ATTACHED, COLUMN_DISP_NAME,DB_COLUMN_ID)values(ident_current('PRG_GRP_BUSS_TABLE'),"
            + "'&',ident_current('prg_db_master_table'),&,'&',&,'&',&)"}, {"addBucketdbMaster", "insert into prg_db_master_table(user_schema,connection_id,table_name,table_alias,table_type,db_query) "
        ...
        , {"addBucketBussMater", "INSERT INTO PRG_GRP_BUSS_TABLE( BUSS_TABLE_NAME, BUSS_DESC, BUSS_TYPE, NO_OF_NODES, IS_PURE_QUERY,DB_TABLE_ID,"
            + "GRP_ID,DB_QUERY)values('&','&','&',&,'Y',ident_current('prg_db_master_table'),&,'&') "} //added newly from sk code
        ...
        , {"insrtbkttabdetails", "insert into PRG_GRP_DIM_TAB_DETAILS(DIM_TAB_ID,COL_ID,IS_AVAILABLE,IS_PK_KEY) VALUES(ident_current('prg_grp_dim_tables'),'&','Y','N')"}, {"insrtbktdimtables", "insert into prg_grp_dim_tables(DIM_ID,TAB_ID,DB_DIM_ID,DB_TAB_ID) VALUES(ident_current('PRG_GRP_DIMENSIONS'),ident_current('PRG_GRP_BUSS_TABLE'),null,null)"}, {"insertbktgrpdims", "insert into PRG_GRP_DIMENSIONS(DIM_NAME,DIM_DESC,DIM_ACTIVE,DEFAULT_HIERARCHY_ID,GRP_ID,QRY_DIM_ID) VALUES('&','&',null,null,'&',null)"}, {"insrtdimrel", "insert into prg_grp_dim_rel(DIM_ID,DESCRIPTION,IS_DEFAULT,REL_NAME) values(ident_current('PRG_GRP_DIMENSIONS'),'&','Y','&')"}, {"insrtreldetails", "insert into PRG_GRP_DIM_REL_DETAILS(REL_ID,MEM_ID,REL_LEVEL) values(ident_current('prg_grp_dim_rel'),ident_current('prg_grp_dim_member'),'&')"}, {"insrtprgdimmember", "insert into prg_grp_dim_member(MEMBER_NAME,DIM_ID,DIM_TAB_ID,USE_DENOM_TABLE,DENOM_QUERY,MEMBER_DESC,MEMBER_ORDER_BY_NAME )VALUES('&',ident_current('PRG_GRP_DIMENSIONS'),ident_current('prg_grp_dim_tables'),'N',null,'&','&')"}, {"inserdimmemdetails1", "insert into prg_grp_dim_member_details(MEM_ID,COL_ID,COL_TYPE,DEFAULT_VAL) VALUES(ident_current('prg_grp_dim_member'),&,'KEY',null)"}, {"inserdimmemdetails2", "insert into prg_grp_dim_member_details(MEM_ID,COL_ID,COL_TYPE,DEFAULT_VAL) VALUES(ident_current('prg_grp_dim_member'),&,'VALUE',null)"}, {"inserdimmemdetails3", "insert into prg_grp_dim_member_details(MEM_ID,COL_ID,COL_TYPE,DEFAULT_VAL) VALUES(ident_current('prg_grp_dim_member'),ident_current('PRG_GRP_BUSS_TABLE_DETAILS'),'KEY',null)"}, {"inserdimmemdetails4", "insert into prg_grp_dim_member_details(MEM_ID,COL_ID,COL_TYPE,DEFAULT_VAL) VALUES(ident_current('prg_grp_dim_member'),ident_current('PRG_GRP_BUSS_TABLE_DETAILS'),'VALUE',null)"} // added by praveen over
